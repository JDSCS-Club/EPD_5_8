...
HAL_StatusTypeDef HAL_RTC_Init(RTC_HandleTypeDef *hrtc)
{
  ...
  do{ (hrtc)->Instance ->WPR = 0xCAU; (hrtc)->Instance ->WPR = 0x53U; } while(0U);

   
  if(RTC_EnterInitMode(hrtc) != HAL_OK)
  {
     
    do{ (hrtc)->Instance ->WPR = 0xFFU; } while(0U); 
  ...
  { 
    ...
    hrtc->Instance->CR &= ((uint32_t)~((0x1U << (6U)) | (0x3U << (21U)) | (0x1U << (20U))));
    ...
    hrtc->Instance->ISR &= (uint32_t)~(0x1U << (7U)); 
    
    hrtc->Instance->TAFCR &= (uint32_t)~(0x1U << (18U));
...
HAL_StatusTypeDef HAL_RTC_DeInit(RTC_HandleTypeDef *hrtc)
{
  ...
  else
  {
    ...
    while(((hrtc->Instance->ISR) & (0x1U << (2U))) == (uint32_t)RESET)
    {
    ...
    if((hrtc->Instance->CR & (0x1U << (5U))) == RESET)
    {
...
HAL_StatusTypeDef HAL_RTC_SetTime(RTC_HandleTypeDef *hrtc, RTC_TimeTypeDef *sTime, uint32_t Format)
{
  ...
  {
    if((hrtc->Instance->CR & (0x1U << (6U))) != (uint32_t)RESET)
    {
      ((void)0U);
      ((void)0U);
    } 
    ...
    tmpreg = (uint32_t)(((uint32_t)RTC_ByteToBcd2(sTime->Hours) << 16U) |                         ((uint32_t)RTC_ByteToBcd2(sTime->Minutes) << 8U) |                         ((uint32_t)RTC_ByteToBcd2(sTime->Seconds)) |                         (((uint32_t)sTime->TimeFormat) << 16U));  
  }
  else
  {
    if((hrtc->Instance->CR & (0x1U << (6U))) != (uint32_t)RESET)
    ...
    ((void)0U);
    ((void)0U);
    tmpreg = (((uint32_t)(sTime->Hours) << 16U) |               ((uint32_t)(sTime->Minutes) << 8U) |               ((uint32_t)sTime->Seconds) |               ((uint32_t)(sTime->TimeFormat) << 16U));   
  }
  ...
  else
  {
    ...
    hrtc->Instance->TR = (uint32_t)(tmpreg & 0x007F7F7FU);
     
     
    hrtc->Instance->CR &= (uint32_t)~(0x1U << (18U));
...
HAL_StatusTypeDef HAL_RTC_GetTime(RTC_HandleTypeDef *hrtc, RTC_TimeTypeDef *sTime, uint32_t Format)
{
  ...
  sTime->SecondFraction = (uint32_t)(hrtc->Instance->PRER & (0x7FFFU << (0U)));

   
  tmpreg = (uint32_t)(hrtc->Instance->TR & 0x007F7F7FU); 
  
   
  sTime->Hours = (uint8_t)((tmpreg & ((0x3U << (20U)) | (0xFU << (16U)))) >> 16U);
  sTime->Minutes = (uint8_t)((tmpreg & ((0x7U << (12U)) | (0xFU << (8U)))) >> 8U);
  sTime->Seconds = (uint8_t)(tmpreg & ((0x7U << (4U)) | (0xFU << (0U))));
  sTime->TimeFormat = (uint8_t)((tmpreg & ((0x1U << (22U)))) >> 16U); 
...
HAL_StatusTypeDef HAL_RTC_SetDate(RTC_HandleTypeDef *hrtc, RTC_DateTypeDef *sDate, uint32_t Format)
{
 ...
 do{ if((hrtc)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (hrtc)->Lock = HAL_LOCKED; } }while (0U);
  ...
  if((Format == 0x00000000U) && ((sDate->Month & 0x10U) == 0x10U))
  {
  ...
  {   
   ...
   datetmpreg = (((uint32_t)RTC_ByteToBcd2(sDate->Year) << 16U) |                  ((uint32_t)RTC_ByteToBcd2(sDate->Month) << 8U) |                  ((uint32_t)RTC_ByteToBcd2(sDate->Date)) |                  ((uint32_t)sDate->WeekDay << 13U));   
  }
  else
  {   
    ((void)0U);
    ...
    datetmpreg = ((((uint32_t)sDate->Year) << 16U) |                   (((uint32_t)sDate->Month) << 8U) |                   ((uint32_t)sDate->Date) |                   (((uint32_t)sDate->WeekDay) << 13U));  
  }
  ...
  else
  {
    ...
    hrtc->Instance->DR = (uint32_t)(datetmpreg & 0x00FFFF3FU);
...
HAL_StatusTypeDef HAL_RTC_GetDate(RTC_HandleTypeDef *hrtc, RTC_DateTypeDef *sDate, uint32_t Format)
{
  ...
  datetmpreg = (uint32_t)(hrtc->Instance->DR & 0x00FFFF3FU); 

   
  sDate->Year = (uint8_t)((datetmpreg & ((0xFU << (20U)) | (0xFU << (16U)))) >> 16U);
  sDate->Month = (uint8_t)((datetmpreg & ((0x1U << (12U)) | (0xFU << (8U)))) >> 8U);
  sDate->Date = (uint8_t)(datetmpreg & ((0x3U << (4U)) | (0xFU << (0U))));
  sDate->WeekDay = (uint8_t)((datetmpreg & ((0x7U << (13U)))) >> 13U); 
...
HAL_StatusTypeDef HAL_RTC_SetAlarm(RTC_HandleTypeDef *hrtc, RTC_AlarmTypeDef *sAlarm, uint32_t Format)
{
  ...
  if(Format == 0x00000000U)
  {
    ...
    if(sAlarm->AlarmDateWeekDaySel == 0x00000000U)
    {
      ((void)0U);
    }
    else
    ...
    tmpreg = (((uint32_t)RTC_ByteToBcd2(sAlarm->AlarmTime.Hours) << 16U) |               ((uint32_t)RTC_ByteToBcd2(sAlarm->AlarmTime.Minutes) << 8U) |               ((uint32_t)RTC_ByteToBcd2(sAlarm->AlarmTime.Seconds)) |               ((uint32_t)(sAlarm->AlarmTime.TimeFormat) << 16U) |               ((uint32_t)RTC_ByteToBcd2(sAlarm->AlarmDateWeekDay) << 24U) |               ((uint32_t)sAlarm->AlarmDateWeekDaySel) |               ((uint32_t)sAlarm->AlarmMask)); 
  }
  else
  {
    if((hrtc->Instance->CR & (0x1U << (6U))) != (uint32_t)RESET)
    ...
    tmpreg = (((uint32_t)(sAlarm->AlarmTime.Hours) << 16U) |               ((uint32_t)(sAlarm->AlarmTime.Minutes) << 8U) |               ((uint32_t) sAlarm->AlarmTime.Seconds) |               ((uint32_t)(sAlarm->AlarmTime.TimeFormat) << 16U) |               ((uint32_t)(sAlarm->AlarmDateWeekDay) << 24U) |               ((uint32_t)sAlarm->AlarmDateWeekDaySel) |               ((uint32_t)sAlarm->AlarmMask));   
  }
  ...
  if(sAlarm->Alarm == (0x1U << (8U)))
  {
     
    ((hrtc)->Instance ->CR &= ~((0x1U << (8U))));
    ...
    while((((((hrtc)->Instance ->ISR) & (0x00000001U)) != RESET)? SET : RESET) == RESET)
    {
      if((HAL_GetTick() - tickstart ) > 1000)
      {
  ...
  else
  {
    ...
    ((hrtc)->Instance ->CR &= ~((0x1U << (9U))));
    
      
    ((hrtc)->Instance ->CR &= ~(0x00002000U));

     
    tickstart = HAL_GetTick();

     
    while((((((hrtc)->Instance ->ISR) & (0x00000002U)) != RESET)? SET : RESET) == RESET)
    {
      if((HAL_GetTick() - tickstart ) > 1000)
      {
...
{
  uint32_t tmpreg = 0U, subsecondtmpreg = 0U;
  volatile uint32_t count = 1000  * (SystemCoreClock / 32U / 1000U) ;
  ...
  if(sAlarm->Alarm == (0x1U << (8U)))
  {
    ...
    ((hrtc)->Instance ->ISR) = (~((0x00000100U) | (0x1U << (7U)))|((hrtc)->Instance ->ISR & (0x1U << (7U))));
  ...
  else
  {
    ...
    ((hrtc)->Instance ->ISR) = (~((0x00000200U) | (0x1U << (7U)))|((hrtc)->Instance ->ISR & (0x1U << (7U))));
  ...
  (((EXTI_TypeDef *) ((0x40000000U + 0x00010000U) + 0x3C00U))->IMR |= ((uint32_t)(0x1U << (17U))));
  
  ((EXTI_TypeDef *) ((0x40000000U + 0x00010000U) + 0x3C00U))->RTSR |= ((uint32_t)(0x1U << (17U)));
...
HAL_StatusTypeDef HAL_RTC_GetAlarm(RTC_HandleTypeDef *hrtc, RTC_AlarmTypeDef *sAlarm, uint32_t Alarm, uint32_t Format)
{
  ...
  if(Alarm == (0x1U << (8U)))
  {
    ...
    sAlarm->Alarm = (0x1U << (8U));
    
    tmpreg = (uint32_t)(hrtc->Instance->ALRMAR);
    subsecondtmpreg = (uint32_t)((hrtc->Instance->ALRMASSR ) & (0x7FFFU << (0U)));
  }
  else
  {
    sAlarm->Alarm = (0x1U << (9U));
    
    tmpreg = (uint32_t)(hrtc->Instance->ALRMBR);
    subsecondtmpreg = (uint32_t)((hrtc->Instance->ALRMBSSR) & (0x7FFFU << (0U)));
  }
    
   
  sAlarm->AlarmTime.Hours = (uint32_t)((tmpreg & ((0x3U << (20U)) | (0xFU << (16U)))) >> 16U);
  sAlarm->AlarmTime.Minutes = (uint32_t)((tmpreg & ((0x7U << (12U)) | (0xFU << (8U)))) >> 8U);
  sAlarm->AlarmTime.Seconds = (uint32_t)(tmpreg & ((0x7U << (4U)) | (0xFU << (0U))));
  sAlarm->AlarmTime.TimeFormat = (uint32_t)((tmpreg & (0x1U << (22U))) >> 16U);
  sAlarm->AlarmTime.SubSeconds = (uint32_t) subsecondtmpreg;
  sAlarm->AlarmDateWeekDay = (uint32_t)((tmpreg & ((0x3U << (28U)) | (0xFU << (24U)))) >> 24U);
  sAlarm->AlarmDateWeekDaySel = (uint32_t)(tmpreg & (0x1U << (30U)));
  sAlarm->AlarmMask = (uint32_t)(tmpreg & 0x80808080U);
...
void HAL_RTC_AlarmIRQHandler(RTC_HandleTypeDef* hrtc)
{  
  if((((((hrtc)->Instance ->ISR)& ((0x00001000U)>> 4U)) != RESET)? SET : RESET))
  {
     
    if((uint32_t)(hrtc->Instance->CR & 0x00001000U) != (uint32_t)RESET)
    {
  ...
  if((((((hrtc)->Instance ->ISR)& ((0x00002000U)>> 4U)) != RESET)? SET : RESET))
  {
     
    if((uint32_t)(hrtc->Instance->CR & 0x00002000U) != (uint32_t)RESET)
    {
  ...
  (((EXTI_TypeDef *) ((0x40000000U + 0x00010000U) + 0x3C00U))->PR = ((uint32_t)(0x1U << (17U))));
...
HAL_StatusTypeDef HAL_RTC_PollForAlarmAEvent(RTC_HandleTypeDef *hrtc, uint32_t Timeout)
{
  ...
  while((((((hrtc)->Instance ->ISR) & (0x00000100U)) != RESET)? SET : RESET) == RESET)
  {
...
HAL_StatusTypeDef HAL_RTC_WaitForSynchro(RTC_HandleTypeDef* hrtc)
{
  ...
  hrtc->Instance->ISR &= (uint32_t)0xFFFFFF5FU;

     
    tickstart = HAL_GetTick();

   
  while((hrtc->Instance->ISR & (0x1U << (5U))) == (uint32_t)RESET)
  {
    if((HAL_GetTick() - tickstart ) > 1000)
    {       
      return HAL_TIMEOUT;
...
HAL_StatusTypeDef RTC_EnterInitMode(RTC_HandleTypeDef* hrtc)
{
  ...
  if((hrtc->Instance->ISR & (0x1U << (6U))) == (uint32_t)RESET)
  {
     
    hrtc->Instance->ISR = (uint32_t)0xFFFFFFFFU;

     
    tickstart = HAL_GetTick();

     
    while((hrtc->Instance->ISR & (0x1U << (6U))) == (uint32_t)RESET)
    {
      if((HAL_GetTick() - tickstart ) > 1000)
      {       
        return HAL_TIMEOUT;
