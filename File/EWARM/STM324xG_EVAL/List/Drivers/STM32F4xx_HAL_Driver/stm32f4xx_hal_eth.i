...
HAL_StatusTypeDef HAL_ETH_Init(ETH_HandleTypeDef *heth)
{
  ...
  do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB2ENR) |= ((0x1U << (14U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB2ENR) & ((0x1U << (14U)))); ((void)(tmpreg)); } while(0U);
  ...
  if((hclk >= 20000000U)&&(hclk < 35000000U))
  {
    ...
    tmpreg1 |= (uint32_t)(0x1U << (3U));
  }
  else if((hclk >= 35000000U)&&(hclk < 60000000U))
  {
      
    tmpreg1 |= (uint32_t)(0x3U << (2U));
  }  
  else if((hclk >= 60000000U)&&(hclk < 100000000U))
  {
      
    tmpreg1 |= (uint32_t)0x00000000U;
  }  
  else if((hclk >= 100000000U)&&(hclk < 150000000U))
  {
      
    tmpreg1 |= (uint32_t)(0x1U << (2U));
  }
  else  
  {
      
    tmpreg1 |= (uint32_t)(0x1U << (4U));    
  }
  ...
  HAL_Delay((0x000000FFU));
  
  if((heth->Init).AutoNegotiation != 0x00000000U)
  {
    ...
    if((HAL_ETH_ReadPHYRegister(heth, ((uint16_t)0x10), &phyreg)) != HAL_OK)
    {
    ...
    if((phyreg & ((uint16_t)0x0004)) != (uint32_t)RESET)
    {
    ...
    else
    {
      ...
      (heth->Init).DuplexMode = 0x00000000U;           
    }
     
    if((phyreg & ((uint16_t)0x0002)) == ((uint16_t)0x0002))
    {  
       
      (heth->Init).Speed = 0x00000000U; 
    }
    else
    {   
        
      (heth->Init).Speed = 0x00004000U;
    }
  }
  else  
  {
    ...
    if(HAL_ETH_WritePHYRegister(heth, ((uint16_t)0x00), ((uint16_t)((heth->Init).DuplexMode >> 3U) |
...
HAL_StatusTypeDef HAL_ETH_DMATxDescListInit(ETH_HandleTypeDef *heth, ETH_DMADescTypeDef *DMATxDescTab, uint8_t *TxBuff, uint32_t TxBuffCount)
{
  ...
  for(i=0U; i < TxBuffCount; i++)
  {
    ...
    dmatxdesc->Status = 0x00100000U;  
    
     
    dmatxdesc->Buffer1Addr = (uint32_t)(&TxBuff[i*1524U]);
    
    if ((heth->Init).ChecksumMode == 0x00000000U)
    {
       
      dmatxdesc->Status |= 0x00C00000U;
    }
...
HAL_StatusTypeDef HAL_ETH_DMARxDescListInit(ETH_HandleTypeDef *heth, ETH_DMADescTypeDef *DMARxDescTab, uint8_t *RxBuff, uint32_t RxBuffCount)
{
  ...
  for(i=0U; i < RxBuffCount; i++)
  {
    ...
    DMARxDesc->Status = 0x80000000U;
    
     
    DMARxDesc->ControlBufferSize = 0x00004000U | 1524U;  
    
     
    DMARxDesc->Buffer1Addr = (uint32_t)(&RxBuff[i*1524U]);
    
    if((heth->Init).RxMode == 0x00000001U)
    {
       
      DMARxDesc->ControlBufferSize &= ~0x80000000U;
    }
...
HAL_StatusTypeDef HAL_ETH_TransmitFrame(ETH_HandleTypeDef *heth, uint32_t FrameLength)
{
  ...
  if(((heth->TxDesc)->Status & 0x80000000U) != (uint32_t)RESET)
  {  
  ...
  if (FrameLength > 1524U)
  {
    bufcount = FrameLength/1524U;
    if (FrameLength % 1524U) 
    {
      bufcount++;
    }
  ...
  if (bufcount == 1U)
  {
    ...
    heth->TxDesc->Status |=0x10000000U|0x20000000U;
     
    heth->TxDesc->ControlBufferSize = (FrameLength & 0x00001FFFU);
     
    heth->TxDesc->Status |= 0x80000000U;
  ...
  else
  {
    for (i=0U; i< bufcount; i++)
    {
      ...
      if (i == 0U) 
      {
        ...
        heth->TxDesc->Status |= 0x10000000U;  
      }
      
       
      heth->TxDesc->ControlBufferSize = (1524U & 0x00001FFFU);
      
      if (i == (bufcount-1U))
      {
         
        heth->TxDesc->Status |= 0x20000000U;
        size = FrameLength - (bufcount-1U)*1524U;
        heth->TxDesc->ControlBufferSize = (size & 0x00001FFFU);
      }
...
HAL_StatusTypeDef HAL_ETH_GetReceivedFrame(ETH_HandleTypeDef *heth)
{
  ...
  
  {
    ...
    if(((heth->RxDesc->Status & 0x00000100U) != (uint32_t)RESET)) 
    {
      ...
      framelength = (((heth->RxDesc)->Status & 0x3FFF0000U) >> 16U) - 4U;
    ...
    else if((heth->RxDesc->Status & 0x00000200U) != (uint32_t)RESET)
    {
      (heth->RxFrameInfos).FSRxDesc = heth->RxDesc;
...
HAL_StatusTypeDef HAL_ETH_GetReceivedFrame_IT(ETH_HandleTypeDef *heth)
{
  ...
  while (((heth->RxDesc->Status & 0x80000000U) == (uint32_t)RESET) && (descriptorscancounter < (4U)))    
  {
    ...
    if((heth->RxDesc->Status & (0x00000200U | 0x00000100U)) == (uint32_t)0x00000200U)
    { 
      heth->RxFrameInfos.FSRxDesc = heth->RxDesc;
      heth->RxFrameInfos.SegCount = 1U;   
    ...
    else if ((heth->RxDesc->Status & (0x00000100U | 0x00000200U)) == (uint32_t)RESET)
    {
    ...
    { 
      ...
      heth->RxFrameInfos.length = (((heth->RxDesc)->Status & 0x3FFF0000U) >> 16U) - 4U;
...
void HAL_ETH_IRQHandler(ETH_HandleTypeDef *heth)
{
  ...
  if ((((heth)->Instance ->DMASR &( 0x00000040U)) == ( 0x00000040U))) 
  {
     
    HAL_ETH_RxCpltCallback(heth);
    
      
    ((heth)->Instance ->DMASR =(0x00000040U));
  ...
  else if ((((heth)->Instance ->DMASR &( 0x00000001U)) == ( 0x00000001U))) 
  {
     
    HAL_ETH_TxCpltCallback(heth);
    
     
    ((heth)->Instance ->DMASR =(0x00000001U));
  ...
  ((heth)->Instance ->DMASR =(0x00010000U));
  
   
  if((((heth)->Instance ->DMASR &( 0x00008000U)) == ( 0x00008000U)))
  {
     
    HAL_ETH_ErrorCallback(heth);

     
    ((heth)->Instance ->DMASR =(0x00008000U));
...
HAL_StatusTypeDef HAL_ETH_ReadPHYRegister(ETH_HandleTypeDef *heth, uint16_t PHYReg, uint32_t *RegValue)
{
  ...
  tmpreg1 |=(((uint32_t)heth->Init.PhyAddress << 11U) & (0x1FU << (11U)));  
  tmpreg1 |=(((uint32_t)PHYReg<<6U) & (0x1FU << (6U)));                    
  tmpreg1 &= ~(0x1U << (1U));                                             
  tmpreg1 |= (0x1U << (0U));                                              
  ...
  while((tmpreg1 & (0x1U << (0U))) == (0x1U << (0U)))
  {
     
    if((HAL_GetTick() - tickstart ) > (0x0000FFFFU))
    {
      heth->State= HAL_ETH_STATE_READY;
...
static void ETH_MACDMAConfig(ETH_HandleTypeDef *heth, uint32_t err)
{
  ...
  macinit.Watchdog = 0x00000000U;
  macinit.Jabber = 0x00000000U;
  macinit.InterFrameGap = 0x00000000U;
  macinit.CarrierSense = 0x00000000U;
  macinit.ReceiveOwn = 0x00000000U;
  macinit.LoopbackMode = 0x00000000U;
  if(heth->Init.ChecksumMode == 0x00000000U)
  {
    macinit.ChecksumOffload = 0x00000400U;
  }
  else
  {
    macinit.ChecksumOffload = 0x00000000U;
  }
  macinit.RetryTransmission = 0x00000200U;
  macinit.AutomaticPadCRCStrip = 0x00000000U;
  macinit.BackOffLimit = 0x00000000U;
  macinit.DeferralCheck = 0x00000000U;
  macinit.ReceiveAll = 0x00000000U;
  macinit.SourceAddrFilter = 0x00000000U;
  macinit.PassControlFrames = 0x00000040U;
  macinit.BroadcastFramesReception = 0x00000000U;
  macinit.DestinationAddrFilter = 0x00000000U;
  macinit.PromiscuousMode = 0x00000000U;
  
  macinit.MulticastFramesFilter = 0x00000010U;
  
  macinit.UnicastFramesFilter = 0x00000000U;
  macinit.HashTableHigh = 0x0U;
  macinit.HashTableLow = 0x0U;
  macinit.PauseTime = 0x0U;
  macinit.ZeroQuantaPause = 0x00000080U;
  macinit.PauseLowThreshold = 0x00000000U;
  macinit.UnicastPauseFrameDetect = 0x00000000U;
  macinit.ReceiveFlowControl = 0x00000000U;
  macinit.TransmitFlowControl = 0x00000000U;
  macinit.VLANTagComparison = 0x00000000U;
  ...
  (heth->Instance)->MACFFR = (uint32_t)(macinit.ReceiveAll | 
   ...
   (heth->Instance)->MACVLANTR = (uint32_t)(macinit.VLANTagComparison | 
    ...
    dmainit.DropTCPIPChecksumErrorFrame = 0x00000000U;
    dmainit.ReceiveStoreForward = 0x02000000U;
    dmainit.FlushReceivedFrame = 0x00000000U;
    dmainit.TransmitStoreForward = 0x00200000U;  
    dmainit.TransmitThresholdControl = 0x00000000U;
    dmainit.ForwardErrorFrames = 0x00000000U;
    dmainit.ForwardUndersizedGoodFrames = 0x00000000U;
    dmainit.ReceiveThresholdControl = 0x00000000U;
    dmainit.SecondFrameOperate = 0x00000004U;
    dmainit.AddressAlignedBeats = 0x02000000U;
    dmainit.FixedBurst = 0x00010000U;
    dmainit.RxDMABurstLength = 0x00400000U;
    dmainit.TxDMABurstLength = 0x00002000U;
    dmainit.EnhancedDescriptorFormat = 0x00000080U;
    dmainit.DescriptorSkipLength = 0x0U;
    dmainit.DMAArbitration = 0x00000000U;
    ...
    (heth->Instance)->DMABMR = (uint32_t)(dmainit.AddressAlignedBeats | 
     ...
     if((heth->Init).RxMode == 0x00000001U)
     {
       ...
       (((heth))->Instance ->DMAIER |= (0x00010000U | 0x00000040U));
     }

       
     ETH_MACAddressConfig(heth, 0x00000000U, heth->Init.MACAddr);
}
...
static void ETH_MACAddressConfig(ETH_HandleTypeDef *heth, uint32_t MacAddr, uint8_t *Addr)
{
  ...
  (*(volatile uint32_t *)((uint32_t)((uint32_t)((((0x40000000U + 0x00020000U) + 0x8000U)) + 0x40U) + MacAddr))) = tmpreg1;
   
  tmpreg1 = ((uint32_t)Addr[3U] << 24U) | ((uint32_t)Addr[2U] << 16U) | ((uint32_t)Addr[1U] << 8U) | Addr[0U];
  
   
  (*(volatile uint32_t *)((uint32_t)((uint32_t)((((0x40000000U + 0x00020000U) + 0x8000U)) + 0x44U) + MacAddr))) = tmpreg1;
}
