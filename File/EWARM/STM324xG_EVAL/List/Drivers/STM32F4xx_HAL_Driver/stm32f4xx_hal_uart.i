...
HAL_StatusTypeDef HAL_MultiProcessor_Init(UART_HandleTypeDef *huart, uint8_t Address, uint32_t WakeUpMethod)
{
  ...
  ((huart->Instance ->CR2) &= ~((0xFU << (0U))));
   
  ((huart->Instance ->CR2) |= (Address));
  
   
  ((huart->Instance ->CR1) &= ~((0x1U << (11U))));
...
HAL_StatusTypeDef HAL_UART_Transmit(UART_HandleTypeDef *huart, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  ...
  if(huart->gState == HAL_UART_STATE_READY) 
  {
    ...
    {
      huart->TxXferCount--;
      if(huart->Init.WordLength == ((uint32_t)(0x1U << (12U))))
      {
        if(UART_WaitOnFlagUntilTimeout(huart, ((uint32_t)(0x1U << (7U))), RESET, tickstart, Timeout) != HAL_OK)
        { 
          return HAL_TIMEOUT;
        }
        tmp = (uint16_t*) pData;
    ...
    if(UART_WaitOnFlagUntilTimeout(huart, ((uint32_t)(0x1U << (6U))), RESET, tickstart, Timeout) != HAL_OK)
    { 
      return HAL_TIMEOUT;
    }
...
{ 
  ...
  { 
    ...
    while(huart->RxXferCount > 0U)
    {
      ...
      if(huart->Init.WordLength == ((uint32_t)(0x1U << (12U))))
      {
        if(UART_WaitOnFlagUntilTimeout(huart, ((uint32_t)(0x1U << (5U))), RESET, tickstart, Timeout) != HAL_OK)
        { 
          return HAL_TIMEOUT;
        }
        tmp = (uint16_t*) pData;
...
HAL_StatusTypeDef HAL_UART_Transmit_DMA(UART_HandleTypeDef *huart, uint8_t *pData, uint16_t Size)
{
  ...
  if(huart->gState == HAL_UART_STATE_READY)
  {
    ...
    ((huart)->Instance ->SR = ~(((uint32_t)(0x1U << (6U)))));
...
HAL_StatusTypeDef HAL_UART_DMAPause(UART_HandleTypeDef *huart)
{
  ...
  do{ if((huart)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (huart)->Lock = HAL_LOCKED; } }while (0U);
  dmarequest = (((huart->Instance ->CR3) & ((0x1U << (7U)))) != RESET);
  if((huart->gState == HAL_UART_STATE_BUSY_TX) && dmarequest)
  {
     
    ((huart->Instance ->CR3) &= ~((0x1U << (7U))));
  }
  dmarequest = (((huart->Instance ->CR3) & ((0x1U << (6U)))) != RESET);
...
HAL_StatusTypeDef HAL_UART_Abort(UART_HandleTypeDef *huart)
{
  ...
  ((huart->Instance ->CR1) &= ~(((0x1U << (5U)) | (0x1U << (8U)) | (0x1U << (7U)) | (0x1U << (6U)))));
  ((huart->Instance ->CR3) &= ~((0x1U << (0U))));
  
   
  if((((huart->Instance ->CR3) & ((0x1U << (7U)))) != RESET))
  {
    ((huart->Instance ->CR3) &= ~((0x1U << (7U))));
...
void HAL_UART_IRQHandler(UART_HandleTypeDef *huart)
{
  ...
  if((errorflags != RESET) && (((cr3its & (0x1U << (0U))) != RESET) || ((cr1its & ((0x1U << (5U)) | (0x1U << (8U)))) != RESET)))
  {
    ...
    if(((isrflags & (0x1U << (3U))) != RESET) && ((cr3its & (0x1U << (0U))) != RESET))
    { 
...
HAL_StatusTypeDef HAL_HalfDuplex_EnableTransmitter(UART_HandleTypeDef *huart)
{
  ...
  tmpreg &= (uint32_t)~((uint32_t)((0x1U << (3U)) | (0x1U << (2U))));
...
static void UART_SetConfig(UART_HandleTypeDef *huart)
{
  ...
  tmpreg &= (uint32_t)~((uint32_t)(0x3U << (12U)));
  ...
  tmpreg &= (uint32_t)~((uint32_t)((0x1U << (12U)) | (0x1U << (10U)) | (0x1U << (9U)) | (0x1U << (3U)) |                                    (0x1U << (2U)) | (0x1U << (15U))));
  ...
  tmpreg &= (uint32_t)~((uint32_t)((0x1U << (8U)) | (0x1U << (9U))));
