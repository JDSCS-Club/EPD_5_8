...
HAL_StatusTypeDef HAL_WWDG_Init(WWDG_HandleTypeDef *hwwdg)
{
  ...
  ((hwwdg->Instance ->CR) = (((0x1U << (7U)) | hwwdg->Init . Counter)));

   
  ((hwwdg->Instance ->CFR) = ((hwwdg->Init . EWIMode | hwwdg->Init . Prescaler | hwwdg->Init . Window)));
...
HAL_StatusTypeDef HAL_WWDG_Refresh(WWDG_HandleTypeDef *hwwdg)
{
  ...
  ((hwwdg->Instance ->CR) = ((hwwdg->Init . Counter)));
...
void HAL_WWDG_IRQHandler(WWDG_HandleTypeDef *hwwdg)
{
  ...
  if((((hwwdg)->Instance ->CFR & ((0x1U << (9U)))) == ((0x1U << (9U)))) != RESET)
  {
     
    if((((hwwdg)->Instance ->SR & ((0x1U << (0U)))) == ((0x1U << (0U)))) != RESET)
    {
       
      (((hwwdg)->Instance ->SR) = ~((0x1U << (0U))));
