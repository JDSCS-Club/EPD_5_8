...
HAL_StatusTypeDef HAL_PWREx_EnableBkUpReg(void)
{
  ...
  *(volatile uint32_t *) (uint32_t)(0x42000000U + ((((0x40000000U + 0x7000U) - 0x40000000U) + 0x04U) * 32U) + ((__iar_builtin_CLZ(__iar_builtin_RBIT((0x1U << (9U))))) * 4U)) = (uint32_t)ENABLE;

   
  tickstart = HAL_GetTick();

     
  while(((((PWR_TypeDef *) (0x40000000U + 0x7000U))->CSR & ((0x1U << (3U)))) == ((0x1U << (3U)))) == RESET)
  {
...
HAL_StatusTypeDef HAL_PWREx_DisableBkUpReg(void)
{
  ...
  *(volatile uint32_t *) (uint32_t)(0x42000000U + ((((0x40000000U + 0x7000U) - 0x40000000U) + 0x04U) * 32U) + ((__iar_builtin_CLZ(__iar_builtin_RBIT((0x1U << (9U))))) * 4U)) = (uint32_t)DISABLE;
...
void HAL_PWREx_EnableFlashPowerDown(void)
{
  *(volatile uint32_t *) (uint32_t)(0x42000000U + ((((0x40000000U + 0x7000U) - 0x40000000U) + 0x00U) * 32U) + ((__iar_builtin_CLZ(__iar_builtin_RBIT((0x1U << (9U))))) * 4U)) = (uint32_t)ENABLE;
}
...
void HAL_PWREx_DisableFlashPowerDown(void)
{
  *(volatile uint32_t *) (uint32_t)(0x42000000U + ((((0x40000000U + 0x7000U) - 0x40000000U) + 0x00U) * 32U) + ((__iar_builtin_CLZ(__iar_builtin_RBIT((0x1U << (9U))))) * 4U)) = (uint32_t)DISABLE;
}
...
uint32_t HAL_PWREx_GetVoltageRange(void)
{
  return (((PWR_TypeDef *) (0x40000000U + 0x7000U))->CR & (0x1U << (14U)));
}
...
HAL_StatusTypeDef HAL_PWREx_ControlVoltageScaling(uint32_t VoltageScaling)
{
  ...
  do { volatile uint32_t tmpreg = 0x00U; (((((PWR_TypeDef *) (0x40000000U + 0x7000U))->CR)) = ((((((((PWR_TypeDef *) (0x40000000U + 0x7000U))->CR))) & (~((0x1U << (14U))))) | ((VoltageScaling))))); tmpreg = ((((PWR_TypeDef *) (0x40000000U + 0x7000U))->CR) & ((0x1U << (14U)))); ((void)(tmpreg)); } while(0U);
  
   
  tickstart = HAL_GetTick();
  while((((((PWR_TypeDef *) (0x40000000U + 0x7000U))->CSR & ((0x1U << (14U)))) == ((0x1U << (14U)))) == RESET))
  {
    if((HAL_GetTick() - tickstart ) > 1000U)
    {
      return HAL_TIMEOUT;
