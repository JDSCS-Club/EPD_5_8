...
HAL_StatusTypeDef HAL_FLASHEx_Erase(FLASH_EraseInitTypeDef *pEraseInit, uint32_t *SectorError)
{
  ...
  if(status == HAL_OK)
  {
    ...
    *SectorError = 0xFFFFFFFFU;
    ...
    if(pEraseInit->TypeErase == 0x00000001U)
    {
...
HAL_StatusTypeDef HAL_FLASHEx_Erase_IT(FLASH_EraseInitTypeDef *pEraseInit)
{
  ...
  (((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->CR |= (0x02000000U));
...
HAL_StatusTypeDef HAL_FLASHEx_OBProgram(FLASH_OBProgramInitTypeDef *pOBInit)
{
  ...
  if((pOBInit->OptionType & 0x00000001U) == 0x00000001U)
  {
    ((void)0U);
    if(pOBInit->WRPState == 0x00000001U)
    {
  ...
  if((pOBInit->OptionType & 0x00000002U) == 0x00000002U)
  {
    status = FLASH_OB_RDP_LevelConfig(pOBInit->RDPLevel);
  }

   
  if((pOBInit->OptionType & 0x00000004U) == 0x00000004U)
  {
    status = FLASH_OB_UserConfig(pOBInit->USERConfig&((uint8_t)0x20), 
                                     pOBInit->USERConfig&((uint8_t)0x40),
                                     pOBInit->USERConfig&((uint8_t)0x80));
  }

   
  if((pOBInit->OptionType & 0x00000008U) == 0x00000008U)
  {
...
void HAL_FLASHEx_OBGetConfig(FLASH_OBProgramInitTypeDef *pOBInit)
{
  pOBInit->OptionType = 0x00000001U | 0x00000002U | 0x00000004U | 0x00000008U;
...
static void FLASH_MassErase(uint8_t VoltageRange, uint32_t Banks)
{
  ...
  ((((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->CR) &= ~((0x3U << (8U))));
  ((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->CR |= (0x1U << (2U));
  ((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->CR |= (0x1U << (16U)) | ((uint32_t)VoltageRange <<8U);
}
...
void FLASH_Erase_Sector(uint32_t Sector, uint8_t VoltageRange)
{
  ...
  if(VoltageRange == 0x00000000U)
  {
     tmp_psize = 0x00000000U;
  }
  else if(VoltageRange == 0x00000001U)
  {
    tmp_psize = 0x00000100U;
  }
  else if(VoltageRange == 0x00000002U)
  {
    tmp_psize = 0x00000200U;
  }
  else
  {
    tmp_psize = 0x00000300U;
  }
  ...
  ((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->CR |= (0x1U << (1U)) | (Sector << (__iar_builtin_CLZ(__iar_builtin_RBIT((0x1FU << (3U))))));
...
static HAL_StatusTypeDef FLASH_OB_EnableWRP(uint32_t WRPSector, uint32_t Banks)
{
  ...
  if(status == HAL_OK)
  { 
    *(volatile uint16_t*)0x40023C16U &= (~WRPSector);  
  }
...
static HAL_StatusTypeDef FLASH_OB_DisableWRP(uint32_t WRPSector, uint32_t Banks)
{
  ...
  if(status == HAL_OK)
  { 
    *(volatile uint16_t*)0x40023C16U |= (uint16_t)WRPSector; 
  }
...
static HAL_StatusTypeDef FLASH_OB_RDP_LevelConfig(uint8_t Level)
{
  ...
  if(status == HAL_OK)
  { 
    *(volatile uint8_t*)0x40023C15U = Level;
  }
...
static HAL_StatusTypeDef FLASH_OB_UserConfig(uint8_t Iwdg, uint8_t Stop, uint8_t Stdby)
{
  ...
  {     
    ...
    optiontmp =  (uint8_t)((*(volatile uint8_t *)0x40023C14U) & (uint8_t)0x1F);

     
    *(volatile uint8_t *)0x40023C14U = Iwdg | (uint8_t)(Stdby | (uint8_t)(Stop | ((uint8_t)optiontmp))); 
  }
...
static HAL_StatusTypeDef FLASH_OB_BOR_LevelConfig(uint8_t Level)
{
  ...
  *(volatile uint8_t *)0x40023C14U &= (~(0x3U << (2U)));
  *(volatile uint8_t *)0x40023C14U |= Level;
...
static uint8_t FLASH_OB_GetUser(void)
{
  ...
  return ((uint8_t)(((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->OPTCR & 0xE0));
}
...
static uint16_t FLASH_OB_GetWRP(void)
{
  ...
  return (*(volatile uint16_t *)(0x40023C16U));
}
...
static uint8_t FLASH_OB_GetRDP(void)
{
  uint8_t readstatus = ((uint8_t)0xAA);

  if((*(volatile uint8_t*)(0x40023C15U) == (uint8_t)((uint8_t)0xCC)))
  {
    readstatus = ((uint8_t)0xCC);
  }
  else if((*(volatile uint8_t*)(0x40023C15U) == (uint8_t)((uint8_t)0x55)))
  {
    readstatus = ((uint8_t)0x55);
  }
  else 
  {
    readstatus = ((uint8_t)0xAA);
  }
...
static uint8_t FLASH_OB_GetBOR(void)
{
  ...
  return (uint8_t)(*(volatile uint8_t *)(0x40023C14U) & (uint8_t)0x0C);
}
...
void FLASH_FlushCaches(void)
{
  ...
  if(((((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->ACR) & ((0x1U << (9U))))!= RESET)
  {
     
    (((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->ACR &= (~(0x1U << (9U))));
     
    do {((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->ACR |= (0x1U << (11U)); ((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->ACR &= ~(0x1U << (11U)); }while(0U);
     
    (((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->ACR |= (0x1U << (9U)));
  }
  
   
  if(((((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->ACR) & ((0x1U << (10U)))) != RESET)
  {
     
    (((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->ACR &= (~(0x1U << (10U))));
     
    do {((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->ACR |= (0x1U << (12U)); ((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->ACR &= ~(0x1U << (12U)); }while(0U);
