...
HAL_StatusTypeDef HAL_ADCEx_InjectedStart(ADC_HandleTypeDef* hadc)
{
  ...
  if((((hadc->Instance ->CR2) & ((0x1U << (0U)))) != RESET))
  {
    ...
    (((hadc->State)) = ((((((hadc->State))) & (~(0x00000001U | 0x00002000U))) | (0x00001000U))));
    ...
    (((hadc)->Instance ->SR) = ~(((uint32_t)(0x1U << (2U)))));
    ...
    {
      tmp1 = (((hadc->Instance ->CR2) & ((0x3U << (20U)))) == RESET);
      tmp2 = (((hadc->Instance ->CR1) & ((0x1U << (10U)))) == RESET);
      if(tmp1 && tmp2)
      {
         
        hadc->Instance->CR2 |= (0x1U << (22U));
      }
    }
    else
    {
...
HAL_StatusTypeDef HAL_ADCEx_InjectedPollForConversion(ADC_HandleTypeDef* hadc, uint32_t Timeout)
{
  ...
  while(!(((((hadc)->Instance ->SR) & (((uint32_t)(0x1U << (2U))))) == (((uint32_t)(0x1U << (2U)))))))
  {
...
HAL_StatusTypeDef HAL_ADCEx_MultiModeStart_DMA(ADC_HandleTypeDef* hadc, uint32_t* pData, uint32_t Length)
{
  ...
  if((((hadc->Instance ->CR2) & ((0x1U << (0U)))) != RESET))
  {
    ...
    (((hadc)->Instance ->SR) = ~(((uint32_t)(0x1U << (1U)))));
...
HAL_StatusTypeDef HAL_ADCEx_InjectedConfigChannel(ADC_HandleTypeDef* hadc, ADC_InjectionConfTypeDef* sConfigInjected)
{
  ...
  if(sConfigInjected->ExternalTrigInjecConv != ((uint32_t)(0xFU << (16U)) + 1U))
  {
    ((void)0U);
  }
  ...
  if (sConfigInjected->InjectedChannel > ((uint32_t)((0x08U << (0U)) | (0x01U << (0U)))))
  {
     
    hadc->Instance->SMPR1 &= ~(((0x7U << (0U))) << (3U * (((uint32_t)((uint16_t)(sConfigInjected->InjectedChannel))) - 10U)));
  ...
  else  
  {
    ...
    hadc->Instance->SMPR2 &= ~(((0x7U << (0U))) << (3U * ((uint32_t)((uint16_t)(sConfigInjected->InjectedChannel)))));
  ...
  hadc->Instance->JSQR &= ~((0x3U << (20U)));
  hadc->Instance->JSQR |=  (((sConfigInjected->InjectedNbrOfConversion) - (uint8_t)1U) << 20U);
  
   
  
   
  hadc->Instance->JSQR &= ~(((uint32_t)((uint16_t)((0x1FU << (0U))))) << (5U * (uint8_t)(((sConfigInjected->InjectedRank) + 3U) - (sConfigInjected->InjectedNbrOfConversion))));
  ...
  {  
    ...
    hadc->Instance->CR2 &= ~((0xFU << (16U)));
    hadc->Instance->CR2 |=  sConfigInjected->ExternalTrigInjecConv;
    
     
    hadc->Instance->CR2 &= ~((0x3U << (20U)));
  ...
  switch(sConfigInjected->InjectedRank)
  {
    case 1U:
      ...
      hadc->Instance->JOFR1 &= ~((0xFFFU << (0U)));
      hadc->Instance->JOFR1 |= sConfigInjected->InjectedOffset;
      break;
    case 2U:
       
      hadc->Instance->JOFR2 &= ~((0xFFFU << (0U)));
      hadc->Instance->JOFR2 |= sConfigInjected->InjectedOffset;
      break;
    case 3U:
       
      hadc->Instance->JOFR3 &= ~((0xFFFU << (0U)));
      hadc->Instance->JOFR3 |= sConfigInjected->InjectedOffset;
      break;
    default:
       
      hadc->Instance->JOFR4 &= ~((0xFFFU << (0U)));
  ...
  if ((hadc->Instance == ((ADC_TypeDef *) ((0x40000000U + 0x00010000U) + 0x2000U))) && (sConfigInjected->InjectedChannel == ((uint32_t)((uint32_t)((0x10U << (0U)) | (0x02U << (0U)))))))
  {
  ...
  if ((hadc->Instance == ((ADC_TypeDef *) ((0x40000000U + 0x00010000U) + 0x2000U))) && ((sConfigInjected->InjectedChannel == ((uint32_t)((uint32_t)(0x10U << (0U))))) || (sConfigInjected->InjectedChannel == ((uint32_t)((uint32_t)((0x10U << (0U)) | (0x01U << (0U))))))))
  {
...
HAL_StatusTypeDef HAL_ADCEx_MultiModeConfigChannel(ADC_HandleTypeDef* hadc, ADC_MultiModeTypeDef* multimode)
{
  ...
  tmpADC_Common->CCR &= ~((0x1FU << (0U)));
  tmpADC_Common->CCR |= multimode->Mode;
  
   
  tmpADC_Common->CCR &= ~((0x3U << (14U)));
  tmpADC_Common->CCR |= multimode->DMAAccessMode;
  
   
  tmpADC_Common->CCR &= ~((0xFU << (8U)));
