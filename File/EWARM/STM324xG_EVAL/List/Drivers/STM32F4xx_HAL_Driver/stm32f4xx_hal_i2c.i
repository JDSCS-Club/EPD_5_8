...
HAL_StatusTypeDef HAL_I2C_Init(I2C_HandleTypeDef *hi2c)
{
  ...
  hi2c->Instance->CCR = (((hi2c->Init . ClockSpeed) <= 100000U)? (((((((pclk1))/(((hi2c->Init . ClockSpeed)) << 1U)) & (0xFFFU << (0U))) < 4U)? 4U:(((pclk1)) / (((hi2c->Init . ClockSpeed)) << 1U)))) : ((((((hi2c->Init . DutyCycle)) == 0x00000000U)? (((pclk1)) / (((hi2c->Init . ClockSpeed)) * 3U)) : ((((pclk1)) / (((hi2c->Init . ClockSpeed)) * 25U)) | (0x1U << (14U)))) & (0xFFFU << (0U))) == 0U)? 1U : ((((((hi2c->Init . DutyCycle)) == 0x00000000U)? (((pclk1)) / (((hi2c->Init . ClockSpeed)) * 3U)) : ((((pclk1)) / (((hi2c->Init . ClockSpeed)) * 25U)) | (0x1U << (14U))))) | (0x1U << (15U))));
...
HAL_StatusTypeDef HAL_I2C_Master_Transmit(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  ...
  if(hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    if((hi2c->Instance->CR1 & (0x1U << (0U))) != (0x1U << (0U)))
    {
    ...
    while(hi2c->XferSize > 0U)
    {
      ...
      if((((((uint8_t)((0x00010004U) >> 16U)) == 0x01U)?((((hi2c)->Instance ->SR1) & ((0x00010004U) & 0x0000FFFFU)) == ((0x00010004U) & 0x0000FFFFU)): ((((hi2c)->Instance ->SR2) & ((0x00010004U) & 0x0000FFFFU)) == ((0x00010004U) & 0x0000FFFFU))) == SET) && (hi2c->XferSize != 0U))
      {
  ...
  if(hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    while(hi2c->XferSize > 0U)
    {
      ...
      else
      {
        ...
        if(((((uint8_t)((0x00010004U) >> 16U)) == 0x01U)?((((hi2c)->Instance ->SR1) & ((0x00010004U) & 0x0000FFFFU)) == ((0x00010004U) & 0x0000FFFFU)): ((((hi2c)->Instance ->SR2) & ((0x00010004U) & 0x0000FFFFU)) == ((0x00010004U) & 0x0000FFFFU))) == SET)
        {
...
HAL_StatusTypeDef HAL_I2C_Slave_Transmit(I2C_HandleTypeDef *hi2c, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  ...
  if(hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    if(hi2c->Init.AddressingMode == ((0x1U << (15U)) | 0x00004000U))
    {
...
HAL_StatusTypeDef HAL_I2C_Slave_Receive(I2C_HandleTypeDef *hi2c, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  ...
  if(hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    while(hi2c->XferSize > 0U)
    {
      ...
      if((((((uint8_t)((0x00010004U) >> 16U)) == 0x01U)?((((hi2c)->Instance ->SR1) & ((0x00010004U) & 0x0000FFFFU)) == ((0x00010004U) & 0x0000FFFFU)): ((((hi2c)->Instance ->SR2) & ((0x00010004U) & 0x0000FFFFU)) == ((0x00010004U) & 0x0000FFFFU))) == SET) && (Size != 0U))
      {
    ...
    do{ volatile uint32_t tmpreg = 0x00U; tmpreg = (hi2c)->Instance ->SR1; (hi2c)->Instance ->CR1 |= (0x1U << (0U)); ((void)(tmpreg)); } while(0);
...
HAL_StatusTypeDef HAL_I2C_Master_Transmit_IT(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint8_t *pData, uint16_t Size)
{
  ...
  if(hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    while(((((uint8_t)((0x00100002U) >> 16U)) == 0x01U)?((((hi2c)->Instance ->SR1) & ((0x00100002U) & 0x0000FFFFU)) == ((0x00100002U) & 0x0000FFFFU)): ((((hi2c)->Instance ->SR2) & ((0x00100002U) & 0x0000FFFFU)) == ((0x00100002U) & 0x0000FFFFU))) != RESET);
...
HAL_StatusTypeDef HAL_I2C_Master_Sequential_Transmit_IT(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint8_t *pData, uint16_t Size, uint32_t XferOptions)
{
  ...
  if(hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    if((XferOptions == 0x00000004U) || (XferOptions == 0x00000001U))
    {
...
HAL_StatusTypeDef HAL_I2C_Master_Sequential_Receive_IT(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint8_t *pData, uint16_t Size, uint32_t XferOptions)
{
  ...
  if(hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    if((hi2c->PreviousState == ((uint32_t)((HAL_I2C_STATE_BUSY_TX & ((uint32_t)((HAL_I2C_STATE_BUSY_TX | HAL_I2C_STATE_BUSY_RX) & (~(uint32_t)HAL_I2C_STATE_READY)))) | HAL_I2C_MODE_MASTER))) || (hi2c->PreviousState == ((uint32_t)(HAL_I2C_MODE_NONE))))
    {
       
      if((XferOptions == 0x00000004U) || (XferOptions == 0x00000001U)  || (XferOptions == 0xFFFF0000U))
      {
...
HAL_StatusTypeDef HAL_I2C_IsDeviceReady(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint32_t Trials, uint32_t Timeout)
{
  ...
  if(hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    do
    {
      ...
      tmp1 = ((((uint8_t)((0x00010002U) >> 16U)) == 0x01U)?((((hi2c)->Instance ->SR1) & ((0x00010002U) & 0x0000FFFFU)) == ((0x00010002U) & 0x0000FFFFU)): ((((hi2c)->Instance ->SR2) & ((0x00010002U) & 0x0000FFFFU)) == ((0x00010002U) & 0x0000FFFFU)));
      tmp2 = ((((uint8_t)((0x00010400U) >> 16U)) == 0x01U)?((((hi2c)->Instance ->SR1) & ((0x00010400U) & 0x0000FFFFU)) == ((0x00010400U) & 0x0000FFFFU)): ((((hi2c)->Instance ->SR2) & ((0x00010400U) & 0x0000FFFFU)) == ((0x00010400U) & 0x0000FFFFU)));
      tmp3 = hi2c->State;
      ...
      if(((((uint8_t)((0x00010002U) >> 16U)) == 0x01U)?((((hi2c)->Instance ->SR1) & ((0x00010002U) & 0x0000FFFFU)) == ((0x00010002U) & 0x0000FFFFU)): ((((hi2c)->Instance ->SR2) & ((0x00010002U) & 0x0000FFFFU)) == ((0x00010002U) & 0x0000FFFFU))) == SET)
      {
...
void HAL_I2C_EV_IRQHandler(I2C_HandleTypeDef *hi2c)
{
  ...
  if((CurrentMode == HAL_I2C_MODE_MASTER) || (CurrentMode == HAL_I2C_MODE_MEM))
  {
    ...
    if(((sr1itflags & 0x00010001U) != RESET) && ((itsources & (0x1U << (9U))) != RESET))
    {
      I2C_Master_SB(hi2c);
    }
     
    else if(((sr1itflags & 0x00010008U) != RESET) && ((itsources & (0x1U << (9U))) != RESET))
    {
      I2C_Master_ADD10(hi2c);
    }
     
    else if(((sr1itflags & 0x00010002U) != RESET) && ((itsources & (0x1U << (9U))) != RESET))
    {
      I2C_Master_ADDR(hi2c);
    }

     
    if((sr2itflags & 0x00100004U) != RESET)
    {
       
      if(((sr1itflags & 0x00010080U) != RESET) && ((itsources & (0x1U << (10U))) != RESET) && ((sr1itflags & 0x00010004U) == RESET))
      {
        I2C_MasterTransmit_TXE(hi2c);
      }
       
      else if(((sr1itflags & 0x00010004U) != RESET) && ((itsources & (0x1U << (9U))) != RESET))
      {
    ...
    else
    {
      ...
      if(((sr1itflags & 0x00010040U) != RESET) && ((itsources & (0x1U << (10U))) != RESET) && ((sr1itflags & 0x00010004U) == RESET))
      {
  ...
  else
  {
    ...
    if(((sr1itflags & 0x00010002U) != RESET) && ((itsources & (0x1U << (9U))) != RESET))
    {
      I2C_Slave_ADDR(hi2c);
    }
     
    else if(((sr1itflags & 0x00010010U) != RESET) && ((itsources & (0x1U << (9U))) != RESET))
    {
      I2C_Slave_STOPF(hi2c);
    }
     
    else if((sr2itflags & 0x00100004U) != RESET)
    {
...
void HAL_I2C_ER_IRQHandler(I2C_HandleTypeDef *hi2c)
{
  ...
  if(((sr1itflags & 0x00010100U) != RESET) && ((itsources & (0x1U << (8U))) != RESET))
  {
  ...
  if(((sr1itflags & 0x00010200U) != RESET) && ((itsources & (0x1U << (8U))) != RESET))
  {
  ...
  if(((sr1itflags & 0x00010400U) != RESET) && ((itsources & (0x1U << (8U))) != RESET))
  {
    tmp1 = hi2c->Mode;
    tmp2 = hi2c->XferCount;
    tmp3 = hi2c->State;
  ...
  if(((sr1itflags & 0x00010800U) != RESET) && ((itsources & (0x1U << (8U))) != RESET))
  {
...
static HAL_StatusTypeDef I2C_MasterTransmit_TXE(I2C_HandleTypeDef *hi2c)
{
  ...
  if((hi2c->XferSize == 0U) && (CurrentState == HAL_I2C_STATE_BUSY_TX))
  {
    ...
    if((CurrentXferOptions != 0x00000004U) && (CurrentXferOptions != 0x00000008U) && (CurrentXferOptions != 0xFFFF0000U))
    {
      ((hi2c)->Instance ->CR2 &= (~((0x1U << (9U)) | (0x1U << (10U)) | (0x1U << (8U)))));
...
static HAL_StatusTypeDef I2C_MasterReceive_RXNE(I2C_HandleTypeDef *hi2c)
{
  if(hi2c->State == HAL_I2C_STATE_BUSY_RX)
  {
    ...
    else
    {
      ...
      if(hi2c->XferOptions == 0x00000002U)
      {
...
static HAL_StatusTypeDef I2C_MasterReceive_BTF(I2C_HandleTypeDef *hi2c)
{
  ...
  else if(hi2c->XferCount == 2U)
  {
    ...
    if((CurrentXferOptions != 0x00000004U) && (CurrentXferOptions != 0x00000008U) && (CurrentXferOptions != 0xFFFF0000U))
    {
      ...
      if((CurrentXferOptions == 0x00000002U) || (CurrentXferOptions == 0x00000001U))
      {
...
static HAL_StatusTypeDef I2C_Master_SB(I2C_HandleTypeDef *hi2c)
{
  if(hi2c->Mode == HAL_I2C_MODE_MEM)
  {
    if(hi2c->EventCount == 0U)
    {
      ...
      hi2c->Instance->DR = ((uint8_t)((hi2c->Devaddress) & (~(0x1U << (0U)))));
    }
    else
    {
      hi2c->Instance->DR = ((uint8_t)((hi2c->Devaddress) | (0x1U << (0U))));
...
static HAL_StatusTypeDef I2C_Master_ADDR(I2C_HandleTypeDef *hi2c)
{
  ...
  if(hi2c->State == HAL_I2C_STATE_BUSY_RX)
  {
    ...
    else if((hi2c->EventCount == 0U) && (hi2c->Init.AddressingMode == ((0x1U << (15U)) | 0x00004000U)))
    {
    ...
    else
    {
      ...
      else if(hi2c->XferCount == 1U)   
      {
        if(CurrentXferOptions == 0xFFFF0000U)
        {
          ...
          if((hi2c->Instance->CR2 & (0x1U << (11U))) == (0x1U << (11U)))
          {
        ...
        else if((CurrentXferOptions != 0x00000004U) && (CurrentXferOptions != 0x00000008U)           && (Prev_State != ((uint32_t)((HAL_I2C_STATE_BUSY_RX & ((uint32_t)((HAL_I2C_STATE_BUSY_TX | HAL_I2C_STATE_BUSY_RX) & (~(uint32_t)HAL_I2C_STATE_READY)))) | HAL_I2C_MODE_MASTER))))
        {
          if(hi2c->XferOptions != 0x00000002U)
          {
...
static HAL_StatusTypeDef I2C_Slave_ADDR(I2C_HandleTypeDef *hi2c)
{
  ...
  if(((((uint8_t)((0x00100004U) >> 16U)) == 0x01U)?((((hi2c)->Instance ->SR1) & ((0x00100004U) & 0x0000FFFFU)) == ((0x00100004U) & 0x0000FFFFU)): ((((hi2c)->Instance ->SR2) & ((0x00100004U) & 0x0000FFFFU)) == ((0x00100004U) & 0x0000FFFFU))) == RESET)
  {
    TransferDirection = 0x00000001U;
  }
  
  if(((((uint8_t)((0x00100080U) >> 16U)) == 0x01U)?((((hi2c)->Instance ->SR1) & ((0x00100080U) & 0x0000FFFFU)) == ((0x00100080U) & 0x0000FFFFU)): ((((hi2c)->Instance ->SR2) & ((0x00100080U) & 0x0000FFFFU)) == ((0x00100080U) & 0x0000FFFFU))) == RESET)
  {
...
static HAL_StatusTypeDef I2C_Slave_STOPF(I2C_HandleTypeDef *hi2c)
{
  ...
  if((hi2c->Instance->CR2 & (0x1U << (11U))) == (0x1U << (11U)))
  {
    ...
    {
      hi2c->XferCount = ((hi2c->hdmarx)->Instance ->NDTR);
    }
    else
    {
  ...
  if(hi2c->XferCount != 0U)
  {
    ...
    if(((((uint8_t)((0x00010040U) >> 16U)) == 0x01U)?((((hi2c)->Instance ->SR1) & ((0x00010040U) & 0x0000FFFFU)) == ((0x00010040U) & 0x0000FFFFU)): ((((hi2c)->Instance ->SR2) & ((0x00010040U) & 0x0000FFFFU)) == ((0x00010040U) & 0x0000FFFFU))) == SET)
    {
...
static HAL_StatusTypeDef I2C_Slave_AF(I2C_HandleTypeDef *hi2c)
{
  ...
  if(((CurrentXferOptions ==  0x00000004U) || (CurrentXferOptions == 0x00000008U)) &&           (CurrentState == HAL_I2C_STATE_LISTEN))
  {
    hi2c->XferOptions = 0xFFFF0000U;
...
static void I2C_ITError(I2C_HandleTypeDef *hi2c)
{
  ...
  else
  {
    ...
    if((hi2c->State != HAL_I2C_STATE_ABORT) && ((hi2c->Instance->CR2 & (0x1U << (11U))) != (0x1U << (11U))))
    {
      hi2c->State = HAL_I2C_STATE_READY;
    }
    hi2c->PreviousState = ((uint32_t)(HAL_I2C_MODE_NONE));
  ...
  if((hi2c->State == HAL_I2C_STATE_LISTEN) && ((hi2c->ErrorCode & 0x00000004U) == 0x00000004U))
  {
    hi2c->XferOptions = 0xFFFF0000U;
    hi2c->PreviousState = ((uint32_t)(HAL_I2C_MODE_NONE));
    hi2c->State = HAL_I2C_STATE_READY;
...
static HAL_StatusTypeDef I2C_MasterRequestWrite(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint32_t Timeout, uint32_t Tickstart)
{
  ...
  if((CurrentXferOptions == 0x00000004U) || (CurrentXferOptions == 0x00000001U) || (CurrentXferOptions == 0xFFFF0000U))
  {
...
static void I2C_DMAError(DMA_HandleTypeDef *hdma)
{
  ...
  if(HAL_DMA_GetError(hdma) != 0x00000002U)
  {
...
static HAL_StatusTypeDef I2C_WaitOnFlagUntilTimeout(I2C_HandleTypeDef *hi2c, uint32_t Flag, FlagStatus Status, uint32_t Timeout, uint32_t Tickstart)
{
  ...
  while((((((uint8_t)((Flag) >> 16U)) == 0x01U)?((((hi2c)->Instance ->SR1) & ((Flag) & 0x0000FFFFU)) == ((Flag) & 0x0000FFFFU)): ((((hi2c)->Instance ->SR2) & ((Flag) & 0x0000FFFFU)) == ((Flag) & 0x0000FFFFU))) ? SET : RESET) == Status) 
  {
...
static HAL_StatusTypeDef I2C_WaitOnMasterAddressFlagUntilTimeout(I2C_HandleTypeDef *hi2c, uint32_t Flag, uint32_t Timeout, uint32_t Tickstart)
{
  while(((((uint8_t)((Flag) >> 16U)) == 0x01U)?((((hi2c)->Instance ->SR1) & ((Flag) & 0x0000FFFFU)) == ((Flag) & 0x0000FFFFU)): ((((hi2c)->Instance ->SR2) & ((Flag) & 0x0000FFFFU)) == ((Flag) & 0x0000FFFFU))) == RESET)
  {
    if(((((uint8_t)((0x00010400U) >> 16U)) == 0x01U)?((((hi2c)->Instance ->SR1) & ((0x00010400U) & 0x0000FFFFU)) == ((0x00010400U) & 0x0000FFFFU)): ((((hi2c)->Instance ->SR2) & ((0x00010400U) & 0x0000FFFFU)) == ((0x00010400U) & 0x0000FFFFU))) == SET)
    {
...
static HAL_StatusTypeDef I2C_WaitOnTXEFlagUntilTimeout(I2C_HandleTypeDef *hi2c, uint32_t Timeout, uint32_t Tickstart)
{    
  while(((((uint8_t)((0x00010080U) >> 16U)) == 0x01U)?((((hi2c)->Instance ->SR1) & ((0x00010080U) & 0x0000FFFFU)) == ((0x00010080U) & 0x0000FFFFU)): ((((hi2c)->Instance ->SR2) & ((0x00010080U) & 0x0000FFFFU)) == ((0x00010080U) & 0x0000FFFFU))) == RESET)
  {
...
static HAL_StatusTypeDef I2C_WaitOnBTFFlagUntilTimeout(I2C_HandleTypeDef *hi2c, uint32_t Timeout, uint32_t Tickstart)
{  
  while(((((uint8_t)((0x00010004U) >> 16U)) == 0x01U)?((((hi2c)->Instance ->SR1) & ((0x00010004U) & 0x0000FFFFU)) == ((0x00010004U) & 0x0000FFFFU)): ((((hi2c)->Instance ->SR2) & ((0x00010004U) & 0x0000FFFFU)) == ((0x00010004U) & 0x0000FFFFU))) == RESET)
  {
...
static HAL_StatusTypeDef I2C_WaitOnSTOPFlagUntilTimeout(I2C_HandleTypeDef *hi2c, uint32_t Timeout, uint32_t Tickstart)
{  
  while(((((uint8_t)((0x00010010U) >> 16U)) == 0x01U)?((((hi2c)->Instance ->SR1) & ((0x00010010U) & 0x0000FFFFU)) == ((0x00010010U) & 0x0000FFFFU)): ((((hi2c)->Instance ->SR2) & ((0x00010010U) & 0x0000FFFFU)) == ((0x00010010U) & 0x0000FFFFU))) == RESET)
  {
...
{  
  ...
  while(((((uint8_t)((0x00010040U) >> 16U)) == 0x01U)?((((hi2c)->Instance ->SR1) & ((0x00010040U) & 0x0000FFFFU)) == ((0x00010040U) & 0x0000FFFFU)): ((((hi2c)->Instance ->SR2) & ((0x00010040U) & 0x0000FFFFU)) == ((0x00010040U) & 0x0000FFFFU))) == RESET)
  {
     
    if(((((uint8_t)((0x00010010U) >> 16U)) == 0x01U)?((((hi2c)->Instance ->SR1) & ((0x00010010U) & 0x0000FFFFU)) == ((0x00010010U) & 0x0000FFFFU)): ((((hi2c)->Instance ->SR2) & ((0x00010010U) & 0x0000FFFFU)) == ((0x00010010U) & 0x0000FFFFU))) == SET)
    {
