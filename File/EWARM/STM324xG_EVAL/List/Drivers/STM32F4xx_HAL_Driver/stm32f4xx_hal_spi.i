...
HAL_StatusTypeDef HAL_SPI_Init(SPI_HandleTypeDef *hspi)
{
  ...
  ((void)0U);
  ((void)0U);
  if(hspi->Init.TIMode == 0x00000000U)
  {
    ((void)0U);
    ((void)0U);
  }
  ((void)0U);
  if(hspi->Init.CRCCalculation == (0x1U << (13U)))
  {
    ((void)0U);
  }
  ...
  ((hspi)->Instance ->CR1 &= (~(0x1U << (6U))));

   
  
 
  ((hspi->Instance ->CR1) = ((hspi->Init . Mode | hspi->Init . Direction | hspi->Init . DataSize | hspi->Init . CLKPolarity | hspi->Init . CLKPhase | (hspi->Init . NSS & (0x1U << (9U))) | hspi->Init . BaudRatePrescaler | hspi->Init . FirstBit | hspi->Init . CRCCalculation)));

   
  ((hspi->Instance ->CR2) = ((((hspi->Init . NSS >> 16U) & (0x1U << (2U))) | hspi->Init . TIMode)));
  ...
  ((hspi->Instance ->I2SCFGR) &= ~((0x1U << (11U))));

  hspi->ErrorCode = 0x00000000U;
...
HAL_StatusTypeDef HAL_SPI_DeInit(SPI_HandleTypeDef *hspi)
{
  ...
  do{ (hspi)->Lock = HAL_UNLOCKED; }while (0U);
...
HAL_StatusTypeDef HAL_SPI_Transmit(SPI_HandleTypeDef *hspi, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  ...
  do{ if((hspi)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (hspi)->Lock = HAL_LOCKED; } }while (0U);
  ...
  if(hspi->Init.Direction == (0x1U << (15U)))
  {
    ((hspi)->Instance ->CR1 |= (0x1U << (14U)));
  }

   
  if(hspi->Init.CRCCalculation == (0x1U << (13U)))
  {
    do{(hspi)->Instance ->CR1 &= (uint16_t)(~(0x1U << (13U))); (hspi)->Instance ->CR1 |= (0x1U << (13U));}while(0U);
  }

   
  if((hspi->Instance->CR1 & (0x1U << (6U))) != (0x1U << (6U)))
  {
  ...
  if(hspi->Init.DataSize == (0x1U << (11U)))
  {
    if((hspi->Init.Mode == 0x00000000U) || (hspi->TxXferCount == 0x01))
    {
    ...
    while (hspi->TxXferCount > 0U)
    {
      ...
      if(((((hspi)->Instance ->SR) & ((0x1U << (1U)))) == ((0x1U << (1U)))))
      {
          hspi->Instance->DR = *((uint16_t *)pData);
          pData += sizeof(uint16_t);
          hspi->TxXferCount--;
  ...
  if(SPI_WaitFlagStateUntilTimeout(hspi, (0x1U << (1U)), SET, Timeout, tickstart) != HAL_OK)
  {
    errorcode = HAL_TIMEOUT;
    goto error;
  }
  ...
  {
    errorcode = HAL_ERROR;
    hspi->ErrorCode = 0x00000020U;
    goto error;
  }

   
  if(hspi->Init.Direction == 0x00000000U)
  {
    do{ volatile uint32_t tmpreg_ovr = 0x00U; tmpreg_ovr = (hspi)->Instance ->DR; tmpreg_ovr = (hspi)->Instance ->SR; ((void)(tmpreg_ovr)); } while(0U);
  }
   
  if(hspi->Init.CRCCalculation == (0x1U << (13U)))
  {
     ((hspi->Instance ->CR1) |= ((0x1U << (12U))));
  }

  if(hspi->ErrorCode != 0x00000000U)
  {
    errorcode = HAL_ERROR;
  }
...
HAL_StatusTypeDef HAL_SPI_Receive(SPI_HandleTypeDef *hspi, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  ...
  if((hspi->Init.Mode == ((0x1U << (2U)) | (0x1U << (8U)))) && (hspi->Init.Direction == 0x00000000U))
  {
  ...
  if(hspi->Init.DataSize == 0x00000000U)
  {
     
    while(hspi->RxXferCount > 0U)
    {
       
      if(((((hspi)->Instance ->SR) & ((0x1U << (0U)))) == ((0x1U << (0U)))))
      {
  ...
  if(hspi->Init.CRCCalculation == (0x1U << (13U)))
  {
    ...
    if(SPI_WaitFlagStateUntilTimeout(hspi, (0x1U << (0U)), SET, Timeout, tickstart) != HAL_OK)
    {
  ...
  if((hspi->Init.Mode == ((0x1U << (2U)) | (0x1U << (8U))))&&((hspi->Init.Direction == (0x1U << (15U)))||(hspi->Init.Direction == (0x1U << (10U)))))
  {
  ...
  if(((((hspi)->Instance ->SR) & ((0x1U << (4U)))) == ((0x1U << (4U)))))
  {
    ((hspi->ErrorCode) |= (0x00000002U));
    ((hspi)->Instance ->SR = (uint16_t)(~(0x1U << (4U))));
  }
...
HAL_StatusTypeDef HAL_SPI_TransmitReceive(SPI_HandleTypeDef *hspi, uint8_t *pTxData, uint8_t *pRxData, uint16_t Size, uint32_t Timeout)
{
  ...
  if(!((tmp == HAL_SPI_STATE_READY) ||     ((tmp1 == ((0x1U << (2U)) | (0x1U << (8U)))) && (hspi->Init.Direction == 0x00000000U) && (tmp == HAL_SPI_STATE_BUSY_RX))))
  {
    errorcode = HAL_BUSY;
    goto error;
  }

  if((pTxData == 0) || (pRxData == 0) || (Size == 0))
  {
    errorcode = HAL_ERROR;
    goto error;
  }
  ...
  if(hspi->Init.DataSize == (0x1U << (11U)))
  {
    if((hspi->Init.Mode == 0x00000000U) || (hspi->TxXferCount == 0x01U))
    {
    ...
    while ((hspi->TxXferCount > 0U) || (hspi->RxXferCount > 0U))
    {
      ...
      if(txallowed && (hspi->TxXferCount > 0U) && (((((hspi)->Instance ->SR) & ((0x1U << (1U)))) == ((0x1U << (1U))))))
      {
        hspi->Instance->DR = *((uint16_t *)pTxData);
        pTxData += sizeof(uint16_t);
        hspi->TxXferCount--;
        ...
        if((hspi->TxXferCount == 0U) && (hspi->Init.CRCCalculation == (0x1U << (13U))))
        {
          ((hspi->Instance ->CR1) |= ((0x1U << (12U))));
        }
      }
      ...
      if((hspi->RxXferCount > 0U) && (((((hspi)->Instance ->SR) & ((0x1U << (0U)))) == ((0x1U << (0U))))))
      {
...
HAL_StatusTypeDef HAL_SPI_Transmit_IT(SPI_HandleTypeDef *hspi, uint8_t *pData, uint16_t Size)
{
  ...
  if (hspi->Init.Direction == 0x00000000U)
  {
    ...
    ((hspi)->Instance ->CR2 |= (((0x1U << (7U)))));
  }
  else
  {
     
    ((hspi)->Instance ->CR2 |= (((0x1U << (7U)) | (0x1U << (5U)))));
  }
...
HAL_StatusTypeDef HAL_SPI_Receive_IT(SPI_HandleTypeDef *hspi, uint8_t *pData, uint16_t Size)
{
  ...
  if((hspi->Init.Direction == 0x00000000U) && (hspi->Init.Mode == ((0x1U << (2U)) | (0x1U << (8U)))))
  {
     hspi->State = HAL_SPI_STATE_BUSY_RX;
  ...
  ((hspi)->Instance ->CR2 |= (((0x1U << (6U)) | (0x1U << (5U)))));
...
HAL_StatusTypeDef HAL_SPI_TransmitReceive_IT(SPI_HandleTypeDef *hspi, uint8_t *pTxData, uint8_t *pRxData, uint16_t Size)
{
  ...
  ((hspi)->Instance ->CR2 |= (((0x1U << (7U)) | (0x1U << (6U)) | (0x1U << (5U)))));
...
HAL_StatusTypeDef HAL_SPI_Transmit_DMA(SPI_HandleTypeDef *hspi, uint8_t *pData, uint16_t Size)
{
  ...
  ((hspi->Instance ->CR2) |= ((0x1U << (5U))));

   
  ((hspi->Instance ->CR2) |= ((0x1U << (1U))));
...
HAL_StatusTypeDef HAL_SPI_TransmitReceive_DMA(SPI_HandleTypeDef *hspi, uint8_t *pTxData, uint8_t *pRxData, uint16_t Size)
{
  ...
  if(!((tmp == HAL_SPI_STATE_READY) ||
      ((tmp1 == ((0x1U << (2U)) | (0x1U << (8U)))) && (hspi->Init.Direction == 0x00000000U) && (tmp == HAL_SPI_STATE_BUSY_RX))))
  {
    errorcode = HAL_BUSY;
    goto error;
  }
...
HAL_StatusTypeDef HAL_SPI_Abort(SPI_HandleTypeDef *hspi)
{
  volatile uint32_t count = 100U * (SystemCoreClock / 24U / 1000U);

   
  if((((hspi->Instance ->CR2) & ((0x1U << (7U)))) != RESET))
  {
    hspi->TxISR = SPI_AbortTx_ISR;
  }

  if((((hspi->Instance ->CR2) & ((0x1U << (6U)))) != RESET))
  {
  ...
  if (((((hspi->Instance ->CR2) & ((0x1U << (1U)))) != RESET)) || ((((hspi->Instance ->CR2) & ((0x1U << (0U)))) != RESET)))
  {
    ...
    if(hspi->hdmatx != 0)
    {
      ...
      while((hspi->Instance->SR & (0x1U << (1U))) == RESET);       
    }
  ...
  do{ volatile uint32_t tmpreg_ovr = 0x00U; tmpreg_ovr = (hspi)->Instance ->DR; tmpreg_ovr = (hspi)->Instance ->SR; ((void)(tmpreg_ovr)); } while(0U);
  do{ volatile uint32_t tmpreg_fre = 0x00U; tmpreg_fre = (hspi)->Instance ->SR; ((void)(tmpreg_fre)); }while(0U);
...
HAL_StatusTypeDef HAL_SPI_Abort_IT(SPI_HandleTypeDef *hspi)
{
  ...
  if(hspi->hdmatx != 0)
  {
    ...
    if((((hspi->Instance ->CR2) & ((0x1U << (1U)))) != RESET))
    {
  ...
  if(hspi->hdmarx != 0)
  {
    ...
    if((((hspi->Instance ->CR2) & ((0x1U << (0U)))) != RESET))
    {
...
HAL_StatusTypeDef HAL_SPI_DMAPause(SPI_HandleTypeDef *hspi)
{
  ...
  ((hspi->Instance ->CR2) &= ~((0x1U << (1U)) | (0x1U << (0U))));
...
void HAL_SPI_IRQHandler(SPI_HandleTypeDef *hspi)
{
  ...
  if(((itflag & (0x1U << (6U))) == RESET) &&
     ((itflag & (0x1U << (0U))) != RESET) && ((itsource & (0x1U << (6U))) != RESET))
  {
    hspi->RxISR(hspi);
    return;
  }
  ...
  if(((itflag & (0x1U << (1U))) != RESET) && ((itsource & (0x1U << (7U))) != RESET))
  {
    hspi->TxISR(hspi);
    return;
  }
  ...
  if(((itflag & ((0x1U << (5U)) | (0x1U << (6U)) | (0x1U << (8U)))) != RESET) && ((itsource & (0x1U << (5U))) != RESET))
  {
    ...
    if((itflag & (0x1U << (5U))) != RESET)
    {
      ((hspi->ErrorCode) |= (0x00000001U));
      do{ volatile uint32_t tmpreg_modf = 0x00U; tmpreg_modf = (hspi)->Instance ->SR; (hspi)->Instance ->CR1 &= (~(0x1U << (6U))); ((void)(tmpreg_modf)); } while(0U);
    }

     
    if((itflag & (0x1U << (8U))) != RESET)
    {
      ((hspi->ErrorCode) |= (0x00000008U));
      do{ volatile uint32_t tmpreg_fre = 0x00U; tmpreg_fre = (hspi)->Instance ->SR; ((void)(tmpreg_fre)); }while(0U);
    }
    ...
    if(hspi->ErrorCode != 0x00000000U)
    {
      ...
      ((hspi)->Instance ->CR2 &= (~((0x1U << (6U)) | (0x1U << (7U)) | (0x1U << (5U)))));

      hspi->State = HAL_SPI_STATE_READY;
       
      if (((((itsource) & ((0x1U << (1U)))) != RESET))||((((itsource) & ((0x1U << (0U)))) != RESET)))
      {
        ((hspi->Instance ->CR2) &= ~(((0x1U << (1U)) | (0x1U << (0U)))));
...
static void SPI_DMAReceiveCplt(DMA_HandleTypeDef *hdma)
{
  ...
  if((hdma->Instance->CR & (0x1U << (8U))) == 0U)
  {
    ...
    if(hspi->Init.CRCCalculation == (0x1U << (13U)))
    {
      ...
      if(SPI_WaitFlagStateUntilTimeout(hspi, (0x1U << (0U)), (0x1U << (0U)), 100U, tickstart) != HAL_OK)
      {
...
static void SPI_DMATransmitReceiveCplt(DMA_HandleTypeDef *hdma)
{
  ...
  if((hdma->Instance->CR & (0x1U << (8U))) == 0U)
  {
    ...
    if(hspi->Init.CRCCalculation == (0x1U << (13U)))
    {
      ...
      if(SPI_WaitFlagStateUntilTimeout(hspi, (0x1U << (0U)), SET, 100U, tickstart) != HAL_OK)
      {
        ((hspi->ErrorCode) |= (0x00000002U));
      }
...
static void SPI_DMATxAbortCallback(DMA_HandleTypeDef *hdma)
{
  ...
  if(hspi->hdmarx != 0)
  {
    if(hspi->hdmarx->XferAbortCallback != 0)
    {
      return;
    }
  }
...
static void SPI_DMARxAbortCallback(DMA_HandleTypeDef *hdma)
{
  ...
  if(hspi->hdmatx != 0)
  {
    if(hspi->hdmatx->XferAbortCallback != 0)
    {
      return;
    }
  }
...
static void SPI_RxISR_8BIT(struct __SPI_HandleTypeDef *hspi)
{
  *hspi->pRxBuffPtr++ = (*(volatile uint8_t *)&hspi->Instance->DR);
  ...
  if((hspi->RxXferCount == 1U) && (hspi->Init.CRCCalculation == (0x1U << (13U))))
  {
    ((hspi->Instance ->CR1) |= ((0x1U << (12U))));
  }
...
static HAL_StatusTypeDef SPI_CheckFlag_BSY(SPI_HandleTypeDef *hspi, uint32_t Timeout, uint32_t Tickstart)
{
  ...
  if(SPI_WaitFlagStateUntilTimeout(hspi, (0x1U << (7U)), RESET, Timeout, Tickstart) != HAL_OK)
  {
    ((hspi->ErrorCode) |= (0x00000020U));
    return HAL_TIMEOUT;
  }
...
static void SPI_CloseRxTx_ISR(SPI_HandleTypeDef *hspi)
{
  ...
  if(((((hspi)->Instance ->SR) & ((0x1U << (4U)))) == ((0x1U << (4U)))) != RESET)
  {
    hspi->State = HAL_SPI_STATE_READY;
    ((hspi->ErrorCode) |= (0x00000002U));
    ((hspi)->Instance ->SR = (uint16_t)(~(0x1U << (4U))));
...
static void SPI_AbortRx_ISR(SPI_HandleTypeDef *hspi)
{
  ...
  tmpreg = (*(volatile uint32_t *)&hspi->Instance->DR);
