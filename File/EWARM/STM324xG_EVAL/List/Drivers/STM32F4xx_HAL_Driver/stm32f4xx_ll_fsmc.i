...
{ 
  ...
  tmpr &= ((uint32_t)~((0x1U << (0U))     | (0x1U << (1U))    | (0x3U << (2U))     |                        (0x3U << (4U))      | (0x1U << (6U))   | (0x1U << (8U))  |                        (0x1U << (9U))   | (0x1U << (10U))  | (0x1U << (11U))  |                        (0x1U << (12U))      | (0x1U << (13U))   | (0x1U << (14U))   |                        (0x1U << (15U)) | (0x7U << (16U))   | (0x1U << (19U))));
   
  tmpr |= (uint32_t)(Init->DataAddressMux       |                     Init->MemoryType           |                     Init->MemoryDataWidth      |                     Init->BurstAccessMode      |                     Init->WaitSignalPolarity   |                     Init->WrapMode             |                     Init->WaitSignalActive     |                     Init->WriteOperation       |                     Init->WaitSignal           |                     Init->ExtendedMode         |                     Init->AsynchronousWait     |                     Init->PageSize             |                     Init->WriteBurst
                     );
            
  if(Init->MemoryType == 0x00000008U)
  {
    tmpr |= (uint32_t)0x00000040U;
  }
...
HAL_StatusTypeDef FSMC_NORSRAM_Timing_Init(FSMC_Bank1_TypeDef *Device, FSMC_NORSRAM_TimingTypeDef *Timing, uint32_t Bank)
{
  ...
  tmpr |= (uint32_t)(Timing->AddressSetupTime                  |                    ((Timing->AddressHoldTime) << 4U)          |                    ((Timing->DataSetupTime) << 8U)            |                    ((Timing->BusTurnAroundDuration) << 16U)   |                    (((Timing->CLKDivision)-1U) << 20U)        |                    (((Timing->DataLatency)-2U) << 24U)        |                    (Timing->AccessMode));
...
HAL_StatusTypeDef  FSMC_NORSRAM_Extended_Timing_Init(FSMC_Bank1E_TypeDef *Device, FSMC_NORSRAM_TimingTypeDef *Timing, uint32_t Bank, uint32_t ExtendedMode)
{
  ...
  if(ExtendedMode == 0x00004000U)
  {
    ...
    tmpr |= (uint32_t)(Timing->AddressSetupTime                  |                      ((Timing->AddressHoldTime) << 4U)          |                      ((Timing->DataSetupTime) << 8U)            |                      ((Timing->BusTurnAroundDuration) << 16U)   |                      (Timing->AccessMode));
...
HAL_StatusTypeDef FSMC_NAND_Init(FSMC_Bank2_3_TypeDef *Device, FSMC_NAND_InitTypeDef *Init)
{
  ...
  tmpr |= (uint32_t)(Init->Waitfeature                |                     0x00000008U        |                     Init->MemoryDataWidth            |                     Init->EccComputation             |                     Init->ECCPageSize                |                     ((Init->TCLRSetupTime) << 9U)    |                     ((Init->TARSetupTime) << 13U));   
...
HAL_StatusTypeDef FSMC_NAND_CommonSpace_Timing_Init(FSMC_Bank2_3_TypeDef *Device, FSMC_NAND_PCC_TimingTypeDef *Timing, uint32_t Bank)
{
  ...
  tmpr |= (uint32_t)(Timing->SetupTime                     |                       ((Timing->WaitSetupTime) << 8U)     |                       ((Timing->HoldSetupTime) << 16U)    |                       ((Timing->HiZSetupTime) << 24U)
                       );
...
HAL_StatusTypeDef FSMC_NAND_DeInit(FSMC_Bank2_3_TypeDef *Device, uint32_t Bank)
{
  ...
  (((Bank) == 0x00000010U)? ((Device)->PCR2 &= ~(0x1U << (2U))): ((Device)->PCR3 &= ~(0x1U << (2U))));
...
HAL_StatusTypeDef FSMC_NAND_GetECC(FSMC_Bank2_3_TypeDef *Device, uint32_t *ECCval, uint32_t Bank, uint32_t Timeout)
{
  ...
  while((((Bank) == 0x00000010U)? (((Device)->SR2 &(0x00000040U)) == (0x00000040U)): (((Device)->SR3 &(0x00000040U)) == (0x00000040U))) == RESET)
  {
...
HAL_StatusTypeDef FSMC_PCCARD_Init(FSMC_Bank4_TypeDef *Device, FSMC_PCCARD_InitTypeDef *Init)
{
  ...
  tmpr &= ((uint32_t)~((0xFU << (13U))  | (0xFU << (9U)) | (0x1U << (1U)) |                        (0x3U << (4U))));
  
   
  tmpr |= (uint32_t)(Init->Waitfeature               |                     0x00000010U  |                     (Init->TCLRSetupTime << 9U)     |                     (Init->TARSetupTime << 13U));
