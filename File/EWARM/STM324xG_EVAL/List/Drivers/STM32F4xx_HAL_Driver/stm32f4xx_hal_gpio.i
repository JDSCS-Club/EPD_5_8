  ...
  for(position = 0U; position < 16U; position++)
  {
    ...
    if(iocurrent == ioposition)
    {
      ...
      if((GPIO_Init->Mode & 0x10000000U) == 0x10000000U)
      {
        ...
        temp |= ((uint32_t)((uint8_t)(((GPIOx) == (((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U))))? 0U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U))))? 1U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0800U))))? 2U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0C00U))))? 3U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1000U))))? 4U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1400U))))? 5U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1800U))))? 6U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1C00U))))? 7U : 8U)) << (4U * (position & 0x03U)));
...
void HAL_GPIO_DeInit(GPIO_TypeDef  *GPIOx, uint32_t GPIO_Pin)
{
  ...
  for(position = 0U; position < 16U; position++)
  {
    ...
    if(iocurrent == ioposition)
    {
      ...
      GPIOx->MODER &= ~((0x3U << (0U)) << (position * 2U));

       
      GPIOx->AFR[position >> 3U] &= ~(0xFU << ((uint32_t)(position & 0x07U) * 4U)) ;

       
      GPIOx->OSPEEDR &= ~((0x3U << (0U)) << (position * 2U));

       
      GPIOx->OTYPER  &= ~((0x1U << (0U)) << position) ;

       
      GPIOx->PUPDR &= ~((0x3U << (0U)) << (position * 2U));
