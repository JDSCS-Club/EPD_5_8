...
HAL_StatusTypeDef HAL_DMA_Init(DMA_HandleTypeDef *hdma)
{
  ...
  tmp &= ((uint32_t)~((0x7U << (25U)) | (0x3U << (23U)) | (0x3U << (21U)) |                       (0x3U << (16U))    | (0x3U << (13U))  | (0x3U << (11U))  |                       (0x1U << (10U))  | (0x1U << (9U))   | (0x1U << (8U))   |                       (0x3U << (6U))   | (0x1U << (19U))     | (0x1U << (18U))));
  ...
  if(hdma->Init.FIFOMode == ((uint32_t)(0x1U << (2U))))
  {
...
HAL_StatusTypeDef HAL_DMA_PollForTransfer(DMA_HandleTypeDef *hdma, HAL_DMA_LevelCompleteTypeDef CompleteLevel, uint32_t Timeout)
{
  ...
  while(((tmpisr & mask_cpltlevel) == RESET) && ((hdma->ErrorCode & 0x00000001U) == RESET))
  {
    ...
    if((tmpisr & (0x00800001U << hdma->StreamIndex)) != RESET)
    {
       
      hdma->ErrorCode |= 0x00000002U;
      
       
      regs->IFCR = 0x00800001U << hdma->StreamIndex;
    }
    
    if((tmpisr & (0x00800004U << hdma->StreamIndex)) != RESET)
    {
       
      hdma->ErrorCode |= 0x00000004U;
      
       
      regs->IFCR = 0x00800004U << hdma->StreamIndex;
    }
  }
...
void HAL_DMA_IRQHandler(DMA_HandleTypeDef *hdma)
{
  ...
  if ((tmpisr & (0x00000008U << hdma->StreamIndex)) != RESET)
  {
    if((((((uint32_t)(0x1U << (2U)))) != 0x00000080U)? ((hdma)->Instance ->CR & (((uint32_t)(0x1U << (2U))))) : ((hdma)->Instance ->FCR & (((uint32_t)(0x1U << (2U)))))) != RESET)
    {
       
      hdma->Instance->CR  &= ~(((uint32_t)(0x1U << (2U))));
  ...
  if ((tmpisr & (0x00800004U << hdma->StreamIndex)) != RESET)
  {
    if((((((uint32_t)(0x1U << (1U)))) != 0x00000080U)? ((hdma)->Instance ->CR & (((uint32_t)(0x1U << (1U))))) : ((hdma)->Instance ->FCR & (((uint32_t)(0x1U << (1U)))))) != RESET)
    {
  ...
  {
    if((((((uint32_t)(0x1U << (3U)))) != 0x00000080U)? ((hdma)->Instance ->CR & (((uint32_t)(0x1U << (3U))))) : ((hdma)->Instance ->FCR & (((uint32_t)(0x1U << (3U)))))) != RESET)
    {
  ...
  {
    if((((((uint32_t)(0x1U << (4U)))) != 0x00000080U)? ((hdma)->Instance ->CR & (((uint32_t)(0x1U << (4U))))) : ((hdma)->Instance ->FCR & (((uint32_t)(0x1U << (4U)))))) != RESET)
    {
      ...
      else
      {
        if((hdma->Instance->CR & (0x1U << (8U))) == RESET)
        {
          ...
          hdma->Instance->CR  &= ~(((uint32_t)(0x1U << (4U))));
...
static HAL_StatusTypeDef DMA_CheckFifoParam(DMA_HandleTypeDef *hdma)
{
  ...
  if(hdma->Init.MemDataAlignment == 0x00000000U)
  {
    ...
    {
    case 0x00000000U:
    case ((uint32_t)(0x2U << (0U))):
      if ((hdma->Init.MemBurst & (0x2U << (23U))) == (0x2U << (23U)))
      {
        status = HAL_ERROR;
      }
      break;
    case ((uint32_t)(0x1U << (0U))):
      if (hdma->Init.MemBurst == ((uint32_t)(0x3U << (23U))))
      {
        status = HAL_ERROR;
      }
      break;
    case ((uint32_t)(0x3U << (0U))):
      break;
    default:
      break;
    }
  ...
  else if (hdma->Init.MemDataAlignment == ((uint32_t)(0x1U << (13U))))
  {
    switch (tmp)
    {
    case 0x00000000U:
