...
HAL_StatusTypeDef HAL_RTCEx_SetTimeStamp(RTC_HandleTypeDef *hrtc, uint32_t TimeStampEdge, uint32_t RTC_TimeStampPin)
{
  ...
  tmpreg = (uint32_t)(hrtc->Instance->CR & (uint32_t)~((0x1U << (3U)) | (0x1U << (11U))));
  ...
  hrtc->Instance->TAFCR &= (uint32_t)~(0x1U << (17U));
  hrtc->Instance->TAFCR |= (uint32_t)(RTC_TimeStampPin); 
  
   
  hrtc->Instance->CR = (uint32_t)tmpreg;
  
  ((hrtc)->Instance ->CR |= ((0x1U << (11U))));
...
HAL_StatusTypeDef HAL_RTCEx_SetTimeStamp_IT(RTC_HandleTypeDef *hrtc, uint32_t TimeStampEdge, uint32_t RTC_TimeStampPin)
{
  ...
  ((hrtc)->Instance ->ISR) = (~((0x00000800U) | (0x1U << (7U)))|((hrtc)->Instance ->ISR & (0x1U << (7U))));

  ((hrtc)->Instance ->CR |= ((0x1U << (11U))));
  
    
  ((hrtc)->Instance ->CR |= (0x00008000U));
  
   
  (((EXTI_TypeDef *) ((0x40000000U + 0x00010000U) + 0x3C00U))->IMR |= ((uint32_t)(0x1U << (21U))));
  
  ((EXTI_TypeDef *) ((0x40000000U + 0x00010000U) + 0x3C00U))->RTSR |= ((uint32_t)(0x1U << (21U)));
...
HAL_StatusTypeDef HAL_RTCEx_GetTimeStamp(RTC_HandleTypeDef *hrtc, RTC_TimeTypeDef* sTimeStamp, RTC_DateTypeDef* sTimeStampDate, uint32_t Format)
{
  ...
  tmptime = (uint32_t)(hrtc->Instance->TSTR & 0x007F7F7FU);
  tmpdate = (uint32_t)(hrtc->Instance->TSDR & 0x00FFFF3FU);

   
  sTimeStamp->Hours = (uint8_t)((tmptime & ((0x3U << (20U)) | (0xFU << (16U)))) >> 16U);
  sTimeStamp->Minutes = (uint8_t)((tmptime & ((0x7U << (12U)) | (0xFU << (8U)))) >> 8U);
  sTimeStamp->Seconds = (uint8_t)(tmptime & ((0x7U << (4U)) | (0xFU << (0U))));
  sTimeStamp->TimeFormat = (uint8_t)((tmptime & ((0x1U << (22U)))) >> 16U);  
  sTimeStamp->SubSeconds = (uint32_t) hrtc->Instance->TSSSR;
  
   
  sTimeStampDate->Year = 0U;
  sTimeStampDate->Month = (uint8_t)((tmpdate & ((0x1U << (12U)) | (0xFU << (8U)))) >> 8U);
  sTimeStampDate->Date = (uint8_t)(tmpdate & ((0x3U << (4U)) | (0xFU << (0U))));
  sTimeStampDate->WeekDay = (uint8_t)((tmpdate & ((0x7U << (13U)))) >> 13U);
...
HAL_StatusTypeDef HAL_RTCEx_SetTamper(RTC_HandleTypeDef *hrtc, RTC_TamperTypeDef* sTamper)
{
  ...
  if(sTamper->Trigger != 0x00000000U)
  { 
    sTamper->Trigger = (uint32_t)(sTamper->Tamper << 1U); 
  } 
        
  tmpreg = ((uint32_t)sTamper->Tamper | (uint32_t)sTamper->PinSelection | (uint32_t)sTamper->Trigger  |            (uint32_t)sTamper->Filter | (uint32_t)sTamper->SamplingFrequency | (uint32_t)sTamper->PrechargeDuration |            (uint32_t)sTamper->TamperPullUp | sTamper->TimeStampOnTamperDetection);
  
  hrtc->Instance->TAFCR &= (uint32_t)~((uint32_t)sTamper->Tamper | (uint32_t)(sTamper->Tamper << 1U) | (uint32_t)(0x1U << (7U)) |                                       (uint32_t)(0x7U << (8U)) | (uint32_t)(0x3U << (11U)) | (uint32_t)(0x3U << (13U)) |                                       (uint32_t)(0x1U << (15U)) | (uint32_t)(0x1U << (16U)) | (uint32_t)(0x1U << (2U)));
...
HAL_StatusTypeDef HAL_RTCEx_SetTamper_IT(RTC_HandleTypeDef *hrtc, RTC_TamperTypeDef* sTamper)
{
  ...
  hrtc->Instance->TAFCR &= (uint32_t)~((uint32_t)sTamper->Tamper | (uint32_t)(sTamper->Tamper << 1U) | (uint32_t)(0x1U << (7U)) |                                       (uint32_t)(0x7U << (8U)) | (uint32_t)(0x3U << (11U)) | (uint32_t)(0x3U << (13U)) |                                       (uint32_t)(0x1U << (15U)) | (uint32_t)(0x1U << (16U)));
    
  hrtc->Instance->TAFCR |= tmpreg;
  
   
  hrtc->Instance->TAFCR |= (uint32_t)(0x1U << (2U));

  if(sTamper->Tamper == (0x1U << (0U)))
  {
     
    ((hrtc)->Instance ->ISR) = (~((0x00002000U) | (0x1U << (7U)))|((hrtc)->Instance ->ISR & (0x1U << (7U))));
  }
  else
  {
     
    ((hrtc)->Instance ->ISR) = (~((0x00004000U) | (0x1U << (7U)))|((hrtc)->Instance ->ISR & (0x1U << (7U))));    
  }
...
void HAL_RTCEx_TamperTimeStampIRQHandler(RTC_HandleTypeDef *hrtc)
{  
  if((((((hrtc)->Instance ->ISR) & ((0x00008000U)>> 4U)) != RESET)? SET : RESET))
  {
     
    if((uint32_t)(hrtc->Instance->CR & 0x00008000U) != (uint32_t)RESET)
    {
  ...
  if((((((hrtc)->Instance ->ISR) & ((0x00020000U)>> 4U)) != RESET)? SET : RESET))
  {
     
    if(((hrtc->Instance->TAFCR & ((0x1U << (2U))))) != (uint32_t)RESET) 
    {
  ...
  if((((((hrtc)->Instance ->ISR) & ((0x00040000U)>> 4U)) != RESET)? SET : RESET))
  {
  ...
  (((EXTI_TypeDef *) ((0x40000000U + 0x00010000U) + 0x3C00U))->PR = ((uint32_t)(0x1U << (21U))));
...
{ 
  ...
  while((((((hrtc)->Instance ->ISR) & (0x00000800U)) != RESET)? SET : RESET) == RESET)
  {
    if((((((hrtc)->Instance ->ISR) & (0x00001000U)) != RESET)? SET : RESET) != RESET)
    {
       
      ((hrtc)->Instance ->ISR) = (~((0x00001000U) | (0x1U << (7U)))|((hrtc)->Instance ->ISR & (0x1U << (7U))));
...
{  
  ...
  while((((((hrtc)->Instance ->ISR) & (0x00002000U)) != RESET)? SET : RESET)== RESET)
  {
    if(Timeout != 0xFFFFFFFFU)
    {
      if((Timeout == 0U)||((HAL_GetTick() - tickstart ) > Timeout))
...
{  
  ...
  while((((((hrtc)->Instance ->ISR) & (0x00004000U)) != RESET)? SET : RESET) == RESET)
  {
    if(Timeout != 0xFFFFFFFFU)
    {
      if((Timeout == 0U)||((HAL_GetTick() - tickstart ) > Timeout))
...
HAL_StatusTypeDef HAL_RTCEx_SetWakeUpTimer(RTC_HandleTypeDef *hrtc, uint32_t WakeUpCounter, uint32_t WakeUpClock)
{
  ...
  if((hrtc->Instance->CR & (0x1U << (10U))) != RESET)
  {
    tickstart = HAL_GetTick();

     
    while((((((hrtc)->Instance ->ISR) & (0x00000004U)) != RESET)? SET : RESET) == SET)
    {
  ...
  ((hrtc)->Instance ->CR &= ~((0x1U << (10U))));

  tickstart = HAL_GetTick();

   
  while((((((hrtc)->Instance ->ISR) & (0x00000004U)) != RESET)? SET : RESET) == RESET)
  {
    if((HAL_GetTick() - tickstart ) > 1000)
    {
  ...
  hrtc->Instance->CR &= (uint32_t)~(0x7U << (0U));
...
HAL_StatusTypeDef HAL_RTCEx_SetWakeUpTimer_IT(RTC_HandleTypeDef *hrtc, uint32_t WakeUpCounter, uint32_t WakeUpClock)
{
  ...
  (((EXTI_TypeDef *) ((0x40000000U + 0x00010000U) + 0x3C00U))->IMR |= ((uint32_t)(0x1U << (22U))));

  ((EXTI_TypeDef *) ((0x40000000U + 0x00010000U) + 0x3C00U))->RTSR |= ((uint32_t)(0x1U << (22U)));
  
   
  ((hrtc)->Instance ->ISR) = (~((0x00000400U) | (0x1U << (7U)))|((hrtc)->Instance ->ISR & (0x1U << (7U))));
  
   
  ((hrtc)->Instance ->CR |= (0x00004000U));
...
uint32_t HAL_RTCEx_GetWakeUpTimer(RTC_HandleTypeDef *hrtc)
{
  ...
  return ((uint32_t)(hrtc->Instance->WUTR & (0xFFFFU << (0U)))); 
}
...
void HAL_RTCEx_WakeUpTimerIRQHandler(RTC_HandleTypeDef *hrtc)
{  
  if((((((hrtc)->Instance ->ISR) & ((0x00004000U)>> 4U)) != RESET)? SET : RESET))
  {
     
    if((uint32_t)(hrtc->Instance->CR & 0x00004000U) != (uint32_t)RESET)
    {
  ...
  (((EXTI_TypeDef *) ((0x40000000U + 0x00010000U) + 0x3C00U))->PR = ((uint32_t)(0x1U << (22U))));
...
{  
  ...
  while((((((hrtc)->Instance ->ISR) & (0x00000400U)) != RESET)? SET : RESET) == RESET)
  {
    if(Timeout != 0xFFFFFFFFU)
    {
      if((Timeout == 0U)||((HAL_GetTick() - tickstart ) > Timeout))
...
HAL_StatusTypeDef HAL_RTCEx_SetSmoothCalib(RTC_HandleTypeDef* hrtc, uint32_t SmoothCalibPeriod, uint32_t SmoothCalibPlusPulses, uint32_t SmouthCalibMinusPulsesValue)
{
  ...
  if((hrtc->Instance->ISR & (0x1U << (16U))) != RESET)
  {
   
  tickstart = HAL_GetTick();

     
    while((hrtc->Instance->ISR & (0x1U << (16U))) != RESET)
    {
      if((HAL_GetTick() - tickstart ) > 1000)
      {
...
HAL_StatusTypeDef HAL_RTCEx_SetSynchroShift(RTC_HandleTypeDef* hrtc, uint32_t ShiftAdd1S, uint32_t ShiftSubFS)
{
  ...
  tickstart = HAL_GetTick();
    ...
    while((hrtc->Instance->ISR & (0x1U << (3U))) != RESET)
    {
      if((HAL_GetTick() - tickstart ) > 1000)
      {  
    ...
    if((hrtc->Instance->CR & (0x1U << (4U))) == RESET)
    {
...
HAL_StatusTypeDef HAL_RTCEx_SetCalibrationOutPut(RTC_HandleTypeDef* hrtc, uint32_t CalibOutput)
{
  ...
  hrtc->Instance->CR &= (uint32_t)~(0x1U << (19U));
  
   
  hrtc->Instance->CR |= (uint32_t)CalibOutput;
  
  ((hrtc)->Instance ->CR |= ((0x1U << (23U))));
...
HAL_StatusTypeDef HAL_RTCEx_EnableBypassShadow(RTC_HandleTypeDef* hrtc)
{
  ...
  hrtc->Instance->CR |= (uint8_t)(0x1U << (5U));
...
{  
  ...
  while((((((hrtc)->Instance ->ISR) & (0x00000200U)) != RESET)? SET : RESET) == RESET)
  {
    if(Timeout != 0xFFFFFFFFU)
    {
      if((Timeout == 0U)||((HAL_GetTick() - tickstart ) > Timeout))
