...
uint32_t HAL_GetHalVersion(void)
{
 return (((0x01U) << 24U) |((0x07U) << 16U) |((0x01U) << 8U ) |((0x00U)));
}
...
uint32_t HAL_GetDEVID(void)
{
   return((((DBGMCU_TypeDef *) 0xE0042000U)->IDCODE) & 0x00000FFFU);
}
...
void HAL_EnableCompensationCell(void)
{
  *(volatile uint32_t *)(uint32_t)(0x42000000U + (((((0x40000000U + 0x00010000U) + 0x3800U) - 0x40000000U) + 0x20U) * 32U) + ((__iar_builtin_CLZ(__iar_builtin_RBIT((0x1U << (0U))))) * 4U)) = (uint32_t)ENABLE;
}
...
void HAL_DisableCompensationCell(void)
{
  *(volatile uint32_t *)(uint32_t)(0x42000000U + (((((0x40000000U + 0x00010000U) + 0x3800U) - 0x40000000U) + 0x20U) * 32U) + ((__iar_builtin_CLZ(__iar_builtin_RBIT((0x1U << (0U))))) * 4U)) = (uint32_t)DISABLE;
}
...
void HAL_GetUID(uint32_t *UID)
{
  UID[0] = (uint32_t)(((*((uint32_t *)0x1FFF7A10U))));
  UID[1] = (uint32_t)(((*((uint32_t *)(0x1FFF7A10U + 4U)))));
  UID[2] = (uint32_t)(((*((uint32_t *)(0x1FFF7A10U + 8U)))));
}
