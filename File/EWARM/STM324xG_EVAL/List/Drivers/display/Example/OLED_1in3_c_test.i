...
void OLED_1in3_C_Display(const uint8_t *Image);
...
int OLED_1in3_c_test(void)
{
	...
	uint16_t Imagesize = ((128%8==0)? (128/8): (128/8+1)) * 64;
        
     BlackImage = ((uint8_t *)m_PisplayMemo);
       
        
	MyPrintf_USART1("Paint_NewImage\r\n");
	Paint_NewImage(BlackImage, 128, 64, 180, 0x0000);	
...
void OLED_Print(void)
{
    ...
    nTestCnt++;
        ...
        Paint_DrawString_EN(10, 0, "PA-PAMP", &Font16, 0xFFFF, 0xFFFF);
        ...
        if((sPrintCnt&0x01))
        {
            Paint_DrawString_EN(10, 17, &mLCDPrintBuf[0][0], &Font8, 0xFFFF, 0xFFFF);  
            Paint_DrawString_EN(10, 27, &mLCDPrintBuf[1][0], &Font8, 0xFFFF, 0xFFFF);  
        }
        else
        {
            Paint_DrawString_EN(10, 17, &mLCDPrintBuf_2[0][0], &Font8, 0xFFFF, 0xFFFF);  
            
            
            if(mLed_Process_Flag.tAmp_Vol_UpFlag == 1)
            {
            ...
            else if(mLed_Process_Flag.tAmp_Vol_UpFlag == 0 )
            {
            ...
            Paint_DrawString_EN(10, 27, &mLCDPrintBuf_2[1][0], &Font8, 0xFFFF, 0xFFFF);  
            
     
        }
        

        Paint_DrawString_EN(10, 37, &mLCDPrintBuf[2][0], &Font8, 0xFFFF, 0xFFFF); 
        
        

        
            
        Paint_DrawString_EN(10, 50, &mLCDPrintBuf[3][0], &Font12, 0xFFFF, 0xFFFF); 
        
        
        
        
        
        Paint_DrawNum(10 + 60, 50, (getSW_RS() ? 1 : 0), &Font12, 0, 0xFFFF, 0xFFFF);  
        Paint_DrawNum(10 + 70, 50, (getSW_AR() ? 2 : 0), &Font12, 0, 0xFFFF, 0xFFFF);
        Paint_DrawNum(10 + 80, 50, (getSW_SL() ? 3 : 0), &Font12, 0, 0xFFFF, 0xFFFF);
        Paint_DrawNum(10 + 90, 50, (getSW_SR() ? 4 : 0), &Font12, 0, 0xFFFF, 0xFFFF);
