...
uint8_t SPI4W_Write_Byte(uint8_t value)
{
    ((&SpiMemoryHandle)->Instance ->CR1 |= (0x1U << (6U)));
    ((SPI_TypeDef *) ((0x40000000U + 0x00010000U) + 0x3000U))->CR2 |= (1) << 12;

    while((((SPI_TypeDef *) ((0x40000000U + 0x00010000U) + 0x3000U))->SR & (1 << 1)) == 0)
        ;

    *((volatile uint8_t *)(&((SPI_TypeDef *) ((0x40000000U + 0x00010000U) + 0x3000U))->DR)) = value;

    while(((SPI_TypeDef *) ((0x40000000U + 0x00010000U) + 0x3000U))->SR & (1 << 7)) ; 

    while((((SPI_TypeDef *) ((0x40000000U + 0x00010000U) + 0x3000U))->SR & (1 << 0)) == 0) ; 

    return *((volatile uint8_t *)(&((SPI_TypeDef *) ((0x40000000U + 0x00010000U) + 0x3000U))->DR));
}
...
void I2C_Write_Byte(uint8_t value, uint8_t Cmd)
{
    ...
    if(HAL_I2C_Master_Transmit(&hi2c1, (0X3C << 1) | 0X00, W_Buf, 2, 2) != HAL_OK) {
        Err++;
        if(Err == 1000) {
            MyPrintf_USART1("OLED LCD send error\r\n");
            return ;
        }
    }
}
