                    ...
                    uint16_t Color, DOT_PIXEL Line_width, LINE_STYLE Line_Style)
{
    ...
    for (;;) {
        ...
        if (Line_Style == LINE_STYLE_DOTTED && Dotted_Len % 3 == 0) {
						...
						if(Color)
							Paint_DrawPoint(Xpoint, Ypoint, 0x0000, Line_width, DOT_FILL_AROUND);
            else
							Paint_DrawPoint(Xpoint, Ypoint, 0xFFFF, Line_width, DOT_FILL_AROUND);
            Dotted_Len = 0;
        } else {
    ...
    if (Draw_Fill == DRAW_FILL_FULL) {
        while (XCurrent <= YCurrent ) { 
            for (sCountY = XCurrent; sCountY <= YCurrent; sCountY ++ ) {
                Paint_DrawPoint(X_Center + XCurrent, Y_Center + sCountY, Color, DOT_PIXEL_1X1, DOT_FILL_AROUND);
                Paint_DrawPoint(X_Center - XCurrent, Y_Center + sCountY, Color, DOT_PIXEL_1X1, DOT_FILL_AROUND);
                Paint_DrawPoint(X_Center - sCountY, Y_Center + XCurrent, Color, DOT_PIXEL_1X1, DOT_FILL_AROUND);
                Paint_DrawPoint(X_Center - sCountY, Y_Center - XCurrent, Color, DOT_PIXEL_1X1, DOT_FILL_AROUND);
                Paint_DrawPoint(X_Center - XCurrent, Y_Center - sCountY, Color, DOT_PIXEL_1X1, DOT_FILL_AROUND);
                Paint_DrawPoint(X_Center + XCurrent, Y_Center - sCountY, Color, DOT_PIXEL_1X1, DOT_FILL_AROUND);
                Paint_DrawPoint(X_Center + sCountY, Y_Center - XCurrent, Color, DOT_PIXEL_1X1, DOT_FILL_AROUND);
        ...
        while (XCurrent <= YCurrent ) {
            Paint_DrawPoint(X_Center + XCurrent, Y_Center + YCurrent, Color, Line_width, DOT_FILL_AROUND);
            Paint_DrawPoint(X_Center - XCurrent, Y_Center + YCurrent, Color, Line_width, DOT_FILL_AROUND);
            Paint_DrawPoint(X_Center - YCurrent, Y_Center + XCurrent, Color, Line_width, DOT_FILL_AROUND);
            Paint_DrawPoint(X_Center - YCurrent, Y_Center - XCurrent, Color, Line_width, DOT_FILL_AROUND);
            Paint_DrawPoint(X_Center - XCurrent, Y_Center - YCurrent, Color, Line_width, DOT_FILL_AROUND);
            Paint_DrawPoint(X_Center + XCurrent, Y_Center - YCurrent, Color, Line_width, DOT_FILL_AROUND);
            Paint_DrawPoint(X_Center + YCurrent, Y_Center - XCurrent, Color, Line_width, DOT_FILL_AROUND);
