...
u8_t memp_memory_RAW_PCB_base[(((((4) * (0 + ((((sizeof(struct raw_pcb)) + 4 - 1U) & ~(4-1U)))))) + 4 - 1U))];  static struct memp *memp_tab_RAW_PCB; const struct memp_desc memp_RAW_PCB = {   (((sizeof(struct raw_pcb)) + 4 - 1U) & ~(4-1U)), (4), memp_memory_RAW_PCB_base, &memp_tab_RAW_PCB };
...
u8_t memp_memory_PBUF_POOL_base[(((((8) * (0 + (((((((((sizeof(struct pbuf)) + 4 - 1U) & ~(4-1U))) + (((((1500 - 40)) + 4 - 1U) & ~(4-1U))))) + 4 - 1U) & ~(4-1U)))))) + 4 - 1U))];  static struct memp *memp_tab_PBUF_POOL; const struct memp_desc memp_PBUF_POOL = {   ((((((((sizeof(struct pbuf)) + 4 - 1U) & ~(4-1U))) + (((((1500 - 40)) + 4 - 1U) & ~(4-1U))))) + 4 - 1U) & ~(4-1U)), (8), memp_memory_PBUF_POOL_base, &memp_tab_PBUF_POOL };
...
do_memp_malloc_pool(const struct memp_desc *desc)
{
  ...
  if (memp != 0) {
    *desc->tab = memp->next;
    do { if (!(((mem_ptr_t)memp % 4) == 0)) { ; }} while(0);
    ;
...
{
  void *memp;
  do { if (!((type < MEMP_MAX))) { ; return 0;;}} while(0);
...
do_memp_free_pool(const struct memp_desc* desc, void *mem)
{
  ...
  do { if (!(((mem_ptr_t)mem % 4) == 0)) { ; }} while(0);
...
memp_free(memp_t type, void *mem)
{
  ...
  do { if (!((type < MEMP_MAX))) { ; return;;}} while(0);
