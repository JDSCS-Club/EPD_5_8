...
void     BSP_LCD_SetTextColor(volatile uint16_t Color);
void     BSP_LCD_SetBackColor(volatile uint16_t Color);
...
typedef struct
{
    ...
    uint8_t sCM8_Self_Test_SP3_St:1;  
    uint8_t sCM8_Self_Test_SP2_St:1;  
    uint8_t sCM8_Self_Test_SP1_St:1;  
    uint8_t sCM8_Sp:4;
    uint8_t sCM8_Self_TestFlag:1;
    
     
    
    uint8_t sCM9_Out_SP_St:1;  
    uint8_t sCM9_In_SP3_St:1;  
    uint8_t sCM9_In_SP2_St:1;  
...
typedef struct
{
    ...
    uint16_t sEth_Rx_Cnt;   
    uint8_t sEth_Rx_RESET_Flag; 
    uint8_t sEth_UpLInk_Cnt; 


    uint8_t sEth_Rx_Flag;               
    ...
    RTC_TIME sClock_Data; 
    
    uint8_t sDhcp_Complete; 
    ...
    uint8_t sAnsm_Run_Flag; 
    
    uint8_t tAmp_Vol_UpFlag; 
    
    
    
    uint8_t sRom_Spk_Flag;
    uint8_t sOut_Spk_Flag;
    uint8_t sSt_Buf_Val[4]; 
    uint8_t sSpk_check_Cnt; 
    uint8_t sSpk_check_Flag; 
    
    uint16_t sCpu_Temp; 
    
    uint8_t sAudio_Play_mode;
    uint8_t sAmp_Fault_Cnt; 
    uint8_t sAmp_Falut_val; 
    uint8_t sAmp_Fault_Cnt_All; 
...
const uint8_t m_LED_FONTDATA_2[100][16]= { 
    ...
    , 
    ...
    , 
...
extern uint8_t SPI_Tx_Buffer[100];
extern volatile uint32_t SPI_FLASH_ID;
...
void LED_GPIO_Init(void)
{
    uint8_t *pVd = (uint8_t *)0x20017000;     

	uint8_t *pVdDot = (uint8_t *)0x20015800;
    
    uint8_t *pVerDisplay = (uint8_t *)0x20013400;
...
void LED_SCREEN_PRINT(void)
{
	...
	int8_t pwmindex = 0;
	uint8_t delaybrightness = 100 - 100;
	...
	for (sAsciiCnt = 0; sAsciiCnt < 50; sAsciiCnt++)
	{
		...
		if (nAscii_Len_Buf[sAsciiCnt])
		{
			...
			else
			{
				...
				if ((nAscii_Len_Buf[sAsciiCnt] & 0xFF) < 0xA1) 
				{
					if ((nAscii_Len_Buf[sAsciiCnt] & 0xFF)) 
					{
...
void LED_Imag_ScreenUp(uint8_t *Imag)
{
	...
	uint8_t *pVd = (uint8_t *)0x20013400;     
...
void LED_Imag_ScreenDown(uint8_t *Imag)
{
	...
	uint32_t Font_16=0;
	uint32_t Lint_sort=0;
	uint8_t *pVd = (uint8_t *)(0x20013400+3072);     
...
void LED_Block_Screen_Buf(void)
{
    ...
    {
        mFdi_Screen_Print =(FDI_SCREEN_BOKCK *) (0x20013400);
    }
    else if (mLed_Process_Flag.sReClock_Start_Flage) 
    {
        mFdi_Screen_Print =(FDI_SCREEN_BOKCK *) (0x20013400);
    }
    else if(mLed_Process_Flag.sEth_Rx_Flag) 
    {
        
        sBlk_Blink_Time = (mLed_Process_Flag.sScreen_Page_Cnt) * 6144;
        
        mFdi_Screen_Print =(FDI_SCREEN_BOKCK *) (0x20017000 + sBlk_Blink_Time);
    }
...
uint8_t LED_Pattern_TEST(void)
{
	...
	uint8_t *pVd_Up = (uint8_t *)0x20013400; 
    uint8_t *pVd_Down = (uint8_t *)(0x20013400+3072);     
    
    uint32_t sFontLen = 0;
    
    
    if(sPattern_Cnt == 9999) 
    {
        sPattern_Cnt = 0;
    }
