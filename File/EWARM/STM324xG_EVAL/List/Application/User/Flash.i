...
char mFlashMemoySaveBuf[100]="SW_UpData_BootLoad!!"; 

uint16_t mFlashSaveCnt = 7000;
uint8_t mFlashFlag = 0; 


volatile uint32_t BootFlashReadAddress;
...
void Flash_Init(void)
{
	...
	FirstSector = GetSector(((uint32_t)0x080E0000));
	 
	NbOfSectors = GetSector(((uint32_t)0x080E0000) + GetSectorSize(((uint32_t)0x080E0000)) -1) - FirstSector + 1;

	 
	EraseInitStruct.TypeErase = 0x00000000U;
	EraseInitStruct.VoltageRange = 0x00000002U;
...
void Flash_Write(uint8_t *pData,uint8_t Len)
{
	...
	for(i = 0; i < Len ;i++)
	{
		if (HAL_FLASH_Program(0x00000000U, FlashAddressPosion, (uint64_t )pData[i]) == HAL_OK)
		{
	...
	if((FlashAddressPosion+100) >= ((uint32_t)0x080E0000) + GetSectorSize(((uint32_t)0x080E0000)) -1)
	{
		Flash_Errase();
	}
...
{
	int i;
	FlashAddressPosion = ((uint32_t)0x080E0000);
	
	 data8 = *(volatile uint32_t*)FlashAddressPosion;
...
static uint32_t GetSector(uint32_t Address)
{
  ...
  if((Address < ((uint32_t)0x08004000)) && (Address >= ((uint32_t)0x08000000)))
  {
    sector = 0U;  
  }
  else if((Address < ((uint32_t)0x08008000)) && (Address >= ((uint32_t)0x08004000)))
  {
    sector = 1U;  
  }
  else if((Address < ((uint32_t)0x0800C000)) && (Address >= ((uint32_t)0x08008000)))
  {
    sector = 2U;  
  }
  else if((Address < ((uint32_t)0x08010000)) && (Address >= ((uint32_t)0x0800C000)))
  {
    sector = 3U;  
  }
  else if((Address < ((uint32_t)0x08020000)) && (Address >= ((uint32_t)0x08010000)))
  {
    sector = 4U;  
  }
  else if((Address < ((uint32_t)0x08040000)) && (Address >= ((uint32_t)0x08020000)))
  {
    sector = 5U;  
  }
  else if((Address < ((uint32_t)0x08060000)) && (Address >= ((uint32_t)0x08040000)))
  {
    sector = 6U;  
  }
  else if((Address < ((uint32_t)0x08080000)) && (Address >= ((uint32_t)0x08060000)))
  {
    sector = 7U;  
  }
  else if((Address < ((uint32_t)0x080A0000)) && (Address >= ((uint32_t)0x08080000)))
  {
    sector = 8U;  
  }
  else if((Address < ((uint32_t)0x080C0000)) && (Address >= ((uint32_t)0x080A0000)))
  {
    sector = 9U;  
  }
  else if((Address < ((uint32_t)0x080E0000)) && (Address >= ((uint32_t)0x080C0000)))
  {
    sector = 10U;  
  }
  else  
...
static uint32_t GetSectorSize(uint32_t Sector)
{
  ...
  if((Sector == 0U) || (Sector == 1U) || (Sector == 2U) || (Sector == 3U))
  {
    sectorsize = 16 * 1024;
  }
  else if(Sector == 4U)
