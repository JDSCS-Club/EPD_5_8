...
void Timer_init(void)
{
    ...
    TimHandle4.Instance = ((TIM_TypeDef *) (0x40000000U + 0x0800U));

    TimHandle4.Init.Period = 10000-1;
    TimHandle4.Init.Prescaler = (uint32_t) ((SystemCoreClock/2)/10000000) - 1;;
    TimHandle4.Init.ClockDivision = 0x00000000U;
    TimHandle4.Init.CounterMode = 0x00000000U;
    ...
    TimHandle5.Instance = ((TIM_TypeDef *) (0x40000000U + 0x0C00U));

    TimHandle5.Init.Period = 1000-1; 
    TimHandle5.Init.Prescaler = (uint32_t) ((SystemCoreClock/2)/10000000) - 1;;
    TimHandle5.Init.ClockDivision = 0x00000000U;
    TimHandle5.Init.CounterMode = 0x00000000U;
