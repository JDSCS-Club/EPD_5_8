...
void Debug_Do_Porcess(void)
{
	...
	if(cmd_exec){
		if(CheckCMDLine("njw0",0)){
			...
			njw1192_tx_data[0x01] = 0x00 | 0x07;
			...
			njw1192_tx_data[0x00] = 0x00;
			njw1192_tx_data[0x01] = 0x00 | 0x35;
			njw1192_write(njw1192_tx_data);
			while (HAL_I2C_GetState(&hi2c1) != HAL_I2C_STATE_READY)
			{
			}			
			...
			njw1192_tx_data[0x00] = 0x01;
			njw1192_tx_data[0x01] = 0xF0|0x0F;
			njw1192_write(njw1192_tx_data);
			while (HAL_I2C_GetState(&hi2c1) != HAL_I2C_STATE_READY)
			{
			}			
			
			njw1192_tx_data[0x00] = 0x02;
			njw1192_tx_data[0x01] = 0xF0|0x0F;
			njw1192_write(njw1192_tx_data);
			while (HAL_I2C_GetState(&hi2c1) != HAL_I2C_STATE_READY)
			{
			...
			njw1192_tx_data[0x00] = 0x03;
			njw1192_tx_data[0x01] = 0x00 | 0x00 | 0x00| 0x00;
			njw1192_write(njw1192_tx_data);
			while (HAL_I2C_GetState(&hi2c1) != HAL_I2C_STATE_READY)
			{
			}			
			
			njw1192_tx_data[0x00] = 0x04;
			njw1192_tx_data[0x01] = 0x00 | 0x40 | 0x00 | 0x10 | 0x0C | 0x00;
			njw1192_write(njw1192_tx_data);
			while (HAL_I2C_GetState(&hi2c1) != HAL_I2C_STATE_READY)
			{
			}			
...
void njw1192_write(uint8_t *wData)
{
  static uint8_t njw_i2c_err = 0;
	...
	if(HAL_I2C_Master_Transmit_IT(&hi2c1, (uint16_t)0x40<<1, wData, 2)!= HAL_OK)
	{
...
void njw1192_default_value(void)
{
	...
	if(main_vol_gain>7){
		...
		njw1192_tx_data[0x01] = 0x00 | temp;
	}
	else{
		njw1192_tx_data[0x01] = 0x00 | main_vol_gain;
	}
	ansm_gain_flag = 1;
	...
	njw1192_tx_data[0x01] = temp | 0x0F;
	...
	njw1192_tx_data[0x01] = ((tonebass_gain&0x0F)<<4) | (tonetreble_gain&0x0F);
	...
	njw1192_tx_data[0x01] = 0x80| 0x00 | 0x20 | 0x00 | 0x0C | temp;
