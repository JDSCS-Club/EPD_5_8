...
uint8_t mUSART_TXBuf_1ch[256];
uint8_t mUSART_RXBufBackUp_1ch[256];


uint8_t mUSART_RXBuf_3ch[256];
uint8_t mUSART_GetRXBuf_3ch[5];
uint8_t mUSART_TXBuf_3ch[256];
uint8_t mUSART_RXBufBackUp_3ch[256];

uint8_t mUSART_RXBuf_4ch[256];
...
{  
	...
	if (huart->Instance == ((USART_TypeDef *) ((0x40000000U + 0x00010000U) + 0x1000U)))
	{
		...
		do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB2ENR) |= ((0x1U << (4U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB2ENR) & ((0x1U << (4U)))); ((void)(tmpreg)); } while(0U); 
	...
	else if (huart->Instance == ((USART_TypeDef *) (0x40000000U + 0x4800U)))
	{
		...
		do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1ENR) |= ((0x1U << (18U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1ENR) & ((0x1U << (18U)))); ((void)(tmpreg)); } while(0U); 
...
void HAL_UART_MspDeInit(UART_HandleTypeDef *huart)
{
	...
	if (huart->Instance == ((USART_TypeDef *) ((0x40000000U + 0x00010000U) + 0x1000U)))
	{
		...
		(((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB2RSTR |= ((0x1U << (4U))));
		(((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB2RSTR &= ~((0x1U << (4U))));

		 
		 
		HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U)), ((uint16_t)0x0200));
		 
		HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U)), ((uint16_t)0x0400));
	...
	else if (huart->Instance == ((USART_TypeDef *) (0x40000000U + 0x4800U)))
	{
		...
		HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0C00U)), ((uint16_t)0x0100));
		 
		HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0C00U)), ((uint16_t)0x0200));
...
void USRAT_init(void)
{
    ...
    UartHandle3.Init.WordLength   = 0x00000000U;
    UartHandle3.Init.StopBits     = 0x00000000U;
    UartHandle3.Init.Parity       = 0x00000000U;
    UartHandle3.Init.HwFlowCtl    = 0x00000000U;
    UartHandle3.Init.Mode         = ((uint32_t)((0x1U << (3U)) |(0x1U << (2U))));
    UartHandle3.Init.OverSampling = 0x00000000U;
...
int FunConvHexAsc(uint8_t *InhexData,char *OUTAscData,int Len)
{
	...
	for(i=0;i<Len;i++)
	{
		OUTAscData[sCnt++] = ConvHex2Asc((((InhexData[i])>>4) & 0xf));
		OUTAscData[sCnt++] = ConvHex2Asc(((InhexData[i]) & 0xf));
	}
	return sCnt;
}
...
void USART_RingBuf_Pro(void)
{
    ...
    if(((RingBuf . nPop_Cnt) & 0x0ff) != ((RingBuf . nPush_Cnt) & 0x0ff))
    {
 
        sCh = RingBuf.nRingData[(RingBuf.nPop_Cnt+1)%50].nCh;
...
void DP_RING_BUF_PUSH(uint8_t *pData,uint16_t pLen,uint8_t Ch)
{
	...
	RingBuf.nPush_Cnt++;
	RingBuf.nPush_Cnt = (RingBuf.nPush_Cnt)%50;
	
	if(((RingBuf . nPush_Cnt) & 0x0ff) != ((RingBuf . nPop_Cnt) & 0x0ff))
	{
	...
	{
		RingBuf.nPop_Cnt++;
		RingBuf.nPop_Cnt = (RingBuf.nPop_Cnt)%50;
		RingBuf.nRingData[RingBuf.nPush_Cnt].nLen = sLen;
		RingBuf.nRingData[RingBuf.nPush_Cnt].nCh = sCh;
		memcpy(RingBuf.nRingData[RingBuf.nPush_Cnt].nDataBuf,pData,sLen);
	}
