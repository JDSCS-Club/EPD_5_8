...
uint8_t SPI_Tx_Buffer[100] = "STM32F40x SPI Firmware Library Example: communication with an M25P64 SPI FLASH";


uint8_t SPI_Index, SPI_Rx_Buffer[100];
volatile uint32_t SPI_FLASH_ID;
...
void SPI_FLASH_Main(void)
{
	...
	if((mSPI_Time_Cnt>=5000) && (mSPI_Time_Cnt<=5500))
	{
		...
		sSpi_Mermory_Address = 0x10000 * mSPI_Write_Cnt;
		...
		if(0xC8471A == (SPI_FLASH_ID&0xFFFFFF))
		{
			...
			SPI_FLASH_SectorErase(sSpi_Mermory_Address);  
			
			
			
			SPI_FLASH_BufferWrite(SPI_Tx_Buffer, sSpi_Mermory_Address, 20);  
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
	...
	if (hspi->Instance == ((SPI_TypeDef *) ((0x40000000U + 0x00010000U) + 0x3000U)))
	{

		   
		do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB2ENR) |= ((0x1U << (12U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB2ENR) & ((0x1U << (12U)))); ((void)(tmpreg)); } while(0U);
		...
		GPIO_InitStruct.Alternate = ((uint8_t)0x05);
		HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U)), &GPIO_InitStruct);

		GPIO_InitStruct.Pin = ((uint16_t)0x0020) | ((uint16_t)0x0040);		
		GPIO_InitStruct.Mode = 0x00000002U;
		GPIO_InitStruct.Pull = 0x00000000U;
		GPIO_InitStruct.Speed = 0x00000003U;
		GPIO_InitStruct.Alternate = ((uint8_t)0x05);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
	...
	if (hspi->Instance == ((SPI_TypeDef *) ((0x40000000U + 0x00010000U) + 0x3000U)))
	{
		...
		HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U)), ((uint16_t)0x0020));
		HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U)), ((uint16_t)0x0020) | ((uint16_t)0x0040));
...
void SPI_FLASH_Init(void)
{
	...
	GPIO_InitStructure.Pin = ((uint16_t)0x0020) ;
	...
	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U)),((uint16_t)0x0020),GPIO_PIN_SET);
	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U)), ((uint16_t)0x0020)|((uint16_t)0x0040),GPIO_PIN_SET);



	SpiMemoryHandle.Instance = ((SPI_TypeDef *) ((0x40000000U + 0x00010000U) + 0x3000U));
	SpiMemoryHandle.Init.Mode = ((0x1U << (2U)) | (0x1U << (8U)));
	SpiMemoryHandle.Init.Direction = 0x00000000U;
	SpiMemoryHandle.Init.DataSize = 0x00000000U;
	SpiMemoryHandle.Init.CLKPolarity = 0x00000000U;
	SpiMemoryHandle.Init.CLKPhase = 0x00000000U;
	SpiMemoryHandle.Init.NSS = (0x1U << (9U));
	SpiMemoryHandle.Init.BaudRatePrescaler = 0x00000000U;
	SpiMemoryHandle.Init.FirstBit = 0x00000000U;
	SpiMemoryHandle.Init.TIMode = 0x00000000U;
	SpiMemoryHandle.Init.CRCCalculation = 0x00000000U;
...
void SPI_FLASH_SectorErase(uint32_t SectorAddr)
{
	...
	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U)),((uint16_t)0x0010),GPIO_PIN_RESET);;
	...
	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U)),((uint16_t)0x0010),GPIO_PIN_SET);;
