...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
	...
	if (hspi->Instance == ((SPI_TypeDef *) (0x40000000U + 0x3800U)))
	{

		   
		do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1ENR) |= ((0x1U << (14U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1ENR) & ((0x1U << (14U)))); ((void)(tmpreg)); } while(0U);
		...
		GPIO_InitStruct.Pin = ((uint16_t)0x0002) | ((uint16_t)0x0004) | ((uint16_t)0x0008);
		...
		HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x2000U)), &GPIO_InitStruct);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
	...
	if (hspi->Instance == ((SPI_TypeDef *) (0x40000000U + 0x3800U)))
	{
		...
		(((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1ENR &= ~((0x1U << (14U))));
		...
		HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x2000U)), ((uint16_t)0x0002) | ((uint16_t)0x0004) | ((uint16_t)0x0008));
...
void SPI_FLASH_Init(void)
{
	...
	do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) |= ((0x1U << (8U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) & ((0x1U << (8U)))); ((void)(tmpreg)); } while(0U);

	GPIO_InitStructure.Pin = ((uint16_t)0x0001) |  ((uint16_t)0x0020) | ((uint16_t)0x0010);
	GPIO_InitStructure.Mode = 0x00000001U;
	GPIO_InitStructure.Pull = 0x00000001U;
	GPIO_InitStructure.Speed = 0x00000001U;
	HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x2000U)), &GPIO_InitStructure); 


	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x2000U)), ((uint16_t)0x0001),GPIO_PIN_SET);

	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x2000U)),((uint16_t)0x0020),GPIO_PIN_SET);
	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x2000U)),((uint16_t)0x0010),GPIO_PIN_SET);



	SpiMemoryHandle.Instance = ((SPI_TypeDef *) (0x40000000U + 0x3800U));
...
void SPI_FLASH_SectorErase(uint32_t SectorAddr)
{
	...
	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x2000U)),((uint16_t)0x0001),GPIO_PIN_RESET);;
