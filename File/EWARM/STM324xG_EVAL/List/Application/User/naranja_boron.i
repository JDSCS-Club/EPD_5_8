...
_Bool bCurLedCtr = 0;
_Bool bAmpOnOff = 0;
_Bool bCurAmpOnOff = 0;
_Bool bAmpStateChange = 0;
...
_Bool getStandBy(void){ return HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0800U)), ((uint16_t)0x0100)); }
...
_Bool getLightOn(void){ return HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0C00U)), ((uint16_t)0x8000)); }
...
_Bool getDICtl(void){ return HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1000U)), ((uint16_t)0x0040)); }
...
_Bool getOverrideOn(void){ return HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U)), ((uint16_t)0x0800)); }
void setOverrideOn(GPIO_PinState state){ HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U)), ((uint16_t)0x0800), state); }
...
void setLedCtr(void ){  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1000U)), ((uint16_t)0x0010), 1); }
...
{
	uint8_t id = HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0800U)), ((uint16_t)0x1000));
	id |= HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0800U)), ((uint16_t)0x0800)) << 1;
	id |= HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0800U)), ((uint16_t)0x0400)) << 2;
	id |= HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U)), ((uint16_t)0x0010)) << 3;
	return id;
}
...
ChargeRateState getChargeRateState(void)
{
	...
	else if(u16BatVol >= 2700 && u16BatVol < 3000)
		return CHARGE_RATE_100_UNDER;
	else if(u16BatVol >= 3000)
		return CHARGE_RATE_100_UNDER;
	else
